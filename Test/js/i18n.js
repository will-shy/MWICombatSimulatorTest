      ...
      translation: {
          ...
          ...{
              ...
              abilityDescriptions: {
                  ...
                  "/abilities/shield_bash": "Bashes the targeted enemy with a shield",
      ...
      translation: {
          ...{
              ...
              abilityTooltipText: {
                  ...
                  damageHealReviveEffectText: "{{asDamageType}}{{effectType}}{{effectTarget}}{{accuracyBonusText}}{{baseDamageFlat}}{{maybePlus}}{{baseDamageRatio}}{{combatStyle}}\u4f24\u5bb3\u3002{{dotText}}{{armorDamageText}}{{hpDrainText}}{{pierceText}}{{stunText}}{{blindText}}{{silenceText}}",
          ...
          ...{
              ...
              combatTriggerConditionNames: {
                  ...
                  "/combat_trigger_conditions/maim": "\u81f4\u6b8b\u51cf\u76ca",
