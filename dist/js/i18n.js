      ...
      translation: {
        ...{
          ...
          auth: {
            ...
            serverError: {
              ...
              message:
                "The game server is currently offline due to a game update, maintenance, or server issue. Please refresh to try again in 5-10 minutes.",
            },
            thirdPartyCookieMessage: {
              title: "Login",
              message:
                "Your browser does not support third-party cookies which is needed to play from within an iframe. Please enable third-party cookies or play from <a href='https://www.milkywayidle.com' target='_blank'>www.milkywayidle.com</a>.",
            },
            welcomeBack: { title: "Welcome Back!", logout: "Logout" },
            buttons: { enterGame: "ENTER GAME" },
            confirmationMessages: {
              guestWarning:
                "WARNING: Guest accounts can only login again using the guest password found under Settings.",
              logoutConfirmation: "Are you sure you want to logout?",
            },
            shared: {
              agreeToRulesLabel:
                "I Agree to the <termsLink>Terms</termsLink>, <privacyPolicyLink>Privacy Policy</privacyPolicyLink>, and <gameRulesLink>Game Rules</gameRulesLink>",
              overAge13Label: "I am 13 years of age or older",
              errors: {
                agreeToRulesError: "You must agree to the game rules",
                overAge13Error: "You must be age 13 or older to play",
          ...
          forgotPassword: {
            ...
            infoMessage:
              "If your account is fully registered with a valid email, you will receive a password reset email with instructions. (may need to check junk/spam folder)",
            emailLabel: "Email",
            resetPasswordButton: "Reset Password",
            backToLogin: "Back to Login",
            successMessage:
              "An email has been sent if the email address is associated with an account.",
            errors: {
          ...
          playFromKongregate: {
            ...
            noAccountMessage:
              "You must have a Kongregate account to be able to play.",
            registerButton: "Register",
            signInInfo:
              "Sign in to $t(global.gameName) or create a new account if this is your first time!",
            signInButton: "Sign in from Kongregate",
          },
          loginWithSteam: {
            signInTitle: "Play From Steam",
            signInInfo:
              "Start playing $t(global.gameName) with your Steam account",
            signInButton: "Play From Steam",
            linkAccountTitle: "Have a $t(global.gameName) account?",
            linkAccountInfo:
              "If you have played $t(global.gameName) before from our website, you can link your existing account to Steam.",
            linkAccountButton: "Yes, link my account",
            createAccountButton: "No, create new account",
            steamAuthTicketError:
              "Failed to fetch Steam auth ticket. Please restart Steam and try again.",
          },
          characterSelectPage: {
            ...
            errors: {
              fetchCharacters:
                "Unable to retrieve characters. Please try again later.",
              fetchGameModes:
                "Unable to fetch game mode data. Please try again later.",
              serverUnreachable: "Server unreachable or offline",
              unexpectedError: "Unexpected error",
            },
          },
          gamePage: {
            ...
            bannedMessage:
              'You are banned until {{banExpireTime}}. Reason: "{{banReason}}"',
            refresh: "Refresh",
            ...
            gameServerRestarted:
              "Game server has been restarted. Please refresh the page.",
          },
          header: {
            flee: "Flee",
            stop: "Stop",
            ...
            activePlayers: "Active Players: {{activePlayerCount}}",
            confirmRunAway:
              "Are you sure you want to run away from combat?",
          ...
          navigationBar: {
            ...
            logout: "Logout",
            myStuffTooltip:
              "Inventory, equipment, abilities, houses, and loadouts.",
            marketplaceTooltip:
              "Player-driven market where you can buy and sell items with coins.",
            tasksTooltip:
              "Randomly generated tasks that players can complete for rewards.",
            milkingTooltip: "mooooooooo...",
            foragingTooltip: "Master the skill of picking up things.",
            woodcuttingTooltip: "Chop chop chop.",
            cheesesmithingTooltip:
              "Did you know you can make equipment using these special hardened cheeses?",
            ...
            alchemyTooltip:
              "Transform unwanted items into wanted ones. (hopefully)",
            enhancingTooltip:
              "+5 takes effort, +10 takes luck, +15 is a miracle, and +20 is destiny.",
            combatTooltip:
            ...
            leaderboardTooltip:
              "Shows the top ranked players of each skill.",
            moderatorTooltip: "Banhammer users.",
            settingsTooltip:
              "Update account information and other settings.",
            staminaTooltip:
              "Increases max HP by 10 per level. You gain experience mainly from taking damage and slightly from avoiding damage.",
            intelligenceTooltip:
              "Increases max MP by 10 per level. You gain experience when consuming mana while using abilities.",
            attackTooltip:
            ...
            defenseTooltip:
              "Increases your evasion, armor, and elemental resistances. You gain experience when dodging or mitigating damage.",
            rangedTooltip:
            ...
            magicTooltip:
              "Increases your magic accuracy, magic damage, and elemental resistances. You gain experience when dealing magic damage.",
          ...
          marketplacePanel: {
            ...
            quantityYouCanAfford:
              "Quantity (You Can Afford: {{maxQuantity}})",
            quantityAvailableAtPrice:
              "Quantity (Available At Price: {{marketQuantity}})",
            priceBestSellOffer: "Price (Best Sell Offer: <bestPrice />)",
            priceBestBuyOffer: "Price (Best Buy Offer: <bestPrice />)",
            youGetOrMore:
              "You Get: {{totalValue}}<coin /> ({{taxRate}} Taxed)<br />(more if better offers exist)",
            youPayOrLess:
              "You Pay: {{totalValue}}<coin /><br />(less if better offers exist)",
          ...
          tasksPanel: {
            ...
            taskCooldownDescription:
              "Permanently reduces the waiting time between tasks by 1 hour.",
            blockSlotUpgrade: "+1 Block Slot",
            blockSlotDescription:
              "Adds a block slot, allowing you to block a non-combat skill from being selected for tasks.",
            combatBlockUpgrade: "Unlock Combat Block",
            combatBlockDescription:
              "Unlocks the ability to block combat tasks. You need at least 1 available block slot to use this.",
            tutorialIncomplete:
              "Complete your tutorial tasks to unlock the task board.<br />Your current task can be found in the top-right corner.",
            purplesGift:
              "Purple's Gift: {{unclaimedTaskPoints}} / {{claimCost}} Task Points",
            claim: "Claim",
          ...
          tutorialQuest: {
            purple: "Purple",
            welcomeStartText:
              "Welcome to $t(global.gameName) - a world with magical cows!<br /><br />I'm Purple, the Chief Training Officer (CTO), and also your tour guide today!<br /><br />I'll cast an orange glow to guide you through the training.",
            welcomeButtonText: "Hi Purple!",
            milkCowStartText:
              "Let me first show you what we magical cows are best known for: producing magical milk! By the way, my cousin Burble also works here. Hi Burble!<br /><br />First, try and gather some milk.",
            milkCowCompleteText:
              "Good job! Here's some extra milk and a brush. Magical cows love to be brushed, and happy cows produce milk faster!",
            smithCheeseStartText:
            ...
            smithCheeseCompleteText:
              "Great! Take some extra cheese with you for the next task.",
            smithSwordStartText:
            ...
            smithSwordCompleteText:
              "Awesome! As you level up, equipment can be upgraded to higher tiers! Tools can also be made to improve each of your skills.",
            forageFarmlandStartText:
              "Now let's go forage for some more resources. Head to Farmland and see what items you can gather!",
            forageFarmlandCompleteText:
              "That was fast! Foraging gives you resources used in many skills, including cooking, brewing, and tailoring!",
            cookDonutStartText:
            ...
            cookDonutCompleteText:
              "Fantastic! Food can heal you while in combat. Here's a dozen more donuts for free!",
            fightFlyStartText:
              "Now I want to take you on an expedition to one of our neighboring planets - the Smelly Planet! I hear there are lots of flies, and they bite! You'll want to bring your sword and some donuts. Let's go!",
            fightFlyCompleteText:
              "Battling monsters earns you coins, resources, ability books, and even rare items.<br /><br />If you are knocked out during combat, you will recover in 150 seconds and continue fighting.",
            messageTipsStartText:
              "Looks like the tour is almost over. There's still much more to explore, but don't worry, you won't be alone! Once you level up a little more, you can chat with or get help from other players!<br /><br />You can also buy or sell items in our player-driven marketplace, unless you are playing Ironcow mode.",
            messageTipsButtonText: "OK",
            messageTips2StartText:
              "Before I go, here's a few more tips:<br />- A Game Guide can be found at the bottom of the navigation menu on the left.<br />- If you go offline, you'll continue to make progress for 10 hours (upgradable).<br />- Items, abilities, skills, and enemies can be hovered over (long press on mobile) to see more detailed tooltips.<br /><br />Ok {name}, I have to go now. It's time for my second lunch, and I have four stomachs to fill. Now go explore the Milky Way!",
          ...
          gatheringProductionSkillPanel: { consumables: "Consumables" },
          alchemyPanel: {
          ...
          party: {
            ...
            slot: "Slot {{number}}",
            role: "Role",
            levelRequirement: "Lv. Req",
            addSlot: "Add Slot",
            combatZone: "Combat Zone: {{name}}",
          ...
          skillActionDetail: {
            ...
            requires: "Requires",
            upgradeFrom: "Upgrade<br />From",
            enhancementsLost: "Enhancements<br />will be lost",
            costs: "Costs",
            outputs: "Outputs",
            ...
            decomposeInfo:
              "<span>Decompose:</span> Converts item into component materials.",
            transmuteInfo:
              "<span>Transmute:</span> Converts item into a random related item.",
            ...
            successInfo:
              "<span>Success</span> increases the item's enhancement level by 1.",
            failureInfo:
              "<span>Failure</span> resets the enhancement level to 0 unless protection is used.",
            targetLevel: "Target Level",
            ...
            bosses: "Bosses",
            bossFight:
              "Boss Fight<br />Every {{battlesPerBoss}} <br />Battles",
            monsters: "Monsters",
            repeat: "Repeat",
            gather: "Gather",
            produce: "Produce",
            ...
            noLoadout: "No Loadout",
            confirmStartNow:
              "Are you sure you want to replace your queued actions?",
            buttons: {
              start: "Start",
              startNow: "Start Now",
              stop: "Stop",
          ...
          cowbellStorePanel: {
            ...
            thankYouSupport:
              "Thank you for the support! The purchased Cowbells should appear in your inventory within 1 minute.",
            waitForSteamOverlay: "Wait For Steam Overlay",
            steamOverlayMessage:
              "The Steam overlay will automatically appear to continue your purchase. This usually takes a few seconds but can occasionally take longer. You can close this message afterwards.",
            continuePayment:
              "Click continue to proceed to our payment processor in a new window.",
            guestWarning:
              "Note: This is a guest account. It's recommended to register in Settings -> Account to avoid accidental loss of access",
            continue: "Continue",
            buyConvenienceUpgrade: "Buy Convenience Upgrade",
            quantity: "Quantity",
            limit: "(Limit: {{limit}})",
            buyLimit: "Buy Limit: {{limit}}",
            afterPurchaseHoursofflineProgress:
              "After Purchase: {{limit}} hours offline progress",
            afterPurchaseMarketListings:
              "After Purchase: {{limit}} market listings",
            afterPurchaseActionQueues:
              "After Purchase: {{limit}} action queues",
            afterPurchaseLoadoutSlots:
              "After Purchase: {{limit}} loadout slots",
            ...
            testServerFreeCowbellsSteam:
              "TEST SERVER: You can get cowbells for free. This uses Steam's sandbox payment mode which doesn't actually charge you.",
            testServerFreeCowbellsStripe:
              "TEST SERVER: You can get cowbells for free by putting 4242-4242-4242-4242 as credit card and any inputs for other fields.",
            buyCowbellsNote:
              "NOTE: Purchased Cowbells will appear in your inventory as Bags of 10 Cowbells which can be sold on the market ({{cowbellTaxRate}} coin tax) to other players. Once opened, they are no longer tradable.",
            ...
            upgradeLimitsInfo:
              "Upgrades permanently increases limits. Your current limits can be viewed in Settings.",
            seasonal: "Seasonal",
            unlocked: "Unlocked",
            chatIconsInfo:
              "Chat icons are displayed in front of your name in the chat. Unlocked chat icons can be changed in Settings -> Profile.",
            customChatIconInfo:
              "Upon reaching 50K, 150K, and 200K supporter points, players can request a custom chat icon for each tier reached. The icon must fit the theme of the game and can be requested via #new-ticket on Discord. Each player is eligible for a maximum of three custom icons.",
            nameColorsInfo:
              "Click any of the colors to see a preview with your name. Unlocked colors can be changed in Settings -> Profile.",
            customNameColorInfo:
              "Upon reaching 100K supporter points, players can request a custom name color (or gradient pattern). This can be requested via #new-ticket on Discord.",
            avatarsInfo:
              "Click any of the avatars to see a larger preview. Unlocked avatars can be changed in Settings -> Profile.",
            customAvatarInfo:
              "Upon reaching 250K supporter points, players can request a custom avatar. The avatar design must fit the theme of the game and can be requested via #new-ticket on Discord.",
            avatarOutfitsInfo:
              "Click any of the outfits to see a preview with your avatar. Unlocked outfits can be changed in Settings -> Profile.",
            customAvatarOutfitInfo:
              "Upon reaching 350K supporter points, players can request a custom avatar outfit. The outfit design must fit the theme of the game and can be requested via #new-ticket on Discord.",
            communityBuffsInfo:
          ...
          paymentSuccessPage: {
            ...
            thankYouMessage:
              "Thank you for the support! The purchased Cowbells should appear in your inventory within 1 minute. You can close this tab and go back to the game.",
          },
          paymentCancelPage: {
            paymentCancelled: "Payment Cancelled",
            closeTabMessage:
              "You can close this tab and go back to the game.",
          },
          socialPanel: {
            friends: "Friends",
            referrals: "Referrals",
            ...
            unblock: "Unblock",
            referralBonusFirstLevel:
              "A referred player reached Total Level {{level}}",
            referralBonusPurchase: "A referred player made a purchase",
            reward: "Reward: {{quantity}}",
            claim: "Claim",
            referralInstructions:
              "When someone signs up using your referral link, you'll be eligible for the following rewards:",
            referralInstructionBullets:
              "<ul><li>{{firstLevelCowbells}}<cowbellIcon /> if they reach Total Level {{firstTotalLevel}}.</li><li>Additional {{secondLevelCowbells}}<cowbellIcon /> if they reach Total Level {{secondTotalLevel}}.</li><li>{{purchaseCowbellPercent}} of any Cowbells they purchase.</li></ul>",
            referralLinkCopied: "Link Copied",
            copyLink: "Copy Link",
            referralCount:
              "So far, <span>{{count}}</span> players have signed up using your referral link",
            socialTitle: "Social",
          },
          guildPanel: {
            overview: "Overview",
            ...
            nameContentError:
              "Name can only contain alphabets, numbers, and single spaces between words",
            ...
            decline: "Decline",
            join: "Join",
            createGuildInstructions:
              "You can create a guild for 5M coins. A guild currently provides the following features:",
            createGuildInfoBullets:
              "<ul><li>Guild chat channel and notice board.</li><li>Guild will receive XP and level up as members gain XP in any skill at a ratio of 1:1000.</li><li>{{defaultSlots}} member slots and 1 additional slot for every {{levelsPerSlot}} guild levels.</li><li>Roles can be assigned: Leader, General, Officer, Member.</li></ul>",
            ...
            offline: "Offline",
            disbandInstructions:
              "You can disband if there are no other members or open invites.",
            disbandGuild: "Disband Guild",
            leaveInstructions:
              "You can leave the guild. There are no penalties for leaving.",
          ...
          leaderboardPanel: {
            leaderboard: "Leaderboard",
            noPlayers:
              "No players meet the minimum threshold for this leaderboard.",
          ...
          chat: {
            generalTip:
              "Tip: General channel is an English-only channel for game-related discussions and friendly chats. To maintain a positive and respectful atmosphere, please adhere to the <gameRulesLink>Game Rules</gameRulesLink>.",
            tradeTip:
              "Tip: Trade channel is for advertising item trading and services. Please use whispers for conversations and negotiations.",
            recruitTip:
              "Tip: Recruit channel is for advertising guild/party recruitment and players seeking to join a guild/party. Please use whispers for conversations.",
            beginnerTip:
              "Tip: Feel free to ask questions or chat with other players here. Useful links: <gameGuideLink>Game Guide</gameGuideLink> and <gameRulesLink>Game Rules</gameRulesLink>.",
            whisperTip:
              'Tip: You can whisper other players using the command "/w [playerName] [message]" or simply click on a player\'s name and select whisper.',
            useWhisperCommand: "Use /w Command",
            needPlayerName: "Need Player Name",
            emptyMessage: "Empty Message",
            invalidCommand: "Invalid Command",
            mutedMessage:
              'You are muted until {{muteExpireTime}}. Reason: "{{muteReason}}"',
            generalChatRestriction:
              "You need at least {{generalChatMinLevel}} total level or {{generalChatMinExp}} XP to use general chat",
            chatRestriction:
              "You need at least {{chatMinLevel}} total level to chat",
            enterMessagePlaceholder: "Enter message...",
            sendButton: "Send",
            notifyModsConfirmation:
              "Are you sure you want to notify moderators? This should only be used for urgent issues that require immediate attention.",
            notifyMods: "Notify Mods",
            cancel: "Cancel",
          },
          chatMessage: {
            whisper: "Whisper",
          ...
          characterName: { customIcon: "Custom Icon" },
          textWithLinks: {
            externalLinkWarning:
              "Are you sure you want to open an external link?",
          },
          characterManagement: {
            inventory: "Inventory",
            equipment: "Equipment",
          ...
          equipmentStatsText: {
            weaken:
              "Weaken: When attacked by enemy, reduce enemy's accuracy by {{value}} for 15s, stacking up to 5 times.",
            parry:
              "Parry: {{value}} chance to parry enemy's attack, avoiding damage and retaliating with an instant auto attack.",
            mayhem:
              "Mayhem: Upon missing an auto-attack, {{value}} chance to auto-attack next enemy. Can chain multiple times.",
            curse:
              "Curse: On hit, increases enemy's damage taken by {{value}} for 15s, stacking up to 5 times.",
            pierce:
              "Pierce: On successful auto-attack, {{value}} chance to auto-attack next enemy. Can chain multiple times.",
          },
          itemSelector: {
            count: "Count",
            remove: "Remove",
          ...
          itemDictionary: {
            ...
            anyLowLevelProduction:
              "Any low level production, alchemy, and enhancing actions.",
            anyMediumLevelProduction:
              "Any medium level production, alchemy, and enhancing actions.",
            anyHighLevelProduction:
              "Any high level production, alchemy, and enhancing actions.",
            almostAllMonstersDropCoins: "Almost all monsters drop coins.",
            anyLowLevelMonster: "Any low level monster in normal combat.",
            anyMediumLevelMonster:
              "Any medium level monsters in normal combat.",
            anyHighLevelMonster:
              "Any high level monsters in normal combat.",
            recommendedLevel: "Level {{level}} <Icon /> Recommended",
          },
          ability: {
            level: "Level: {{level}}",
          ...
          abilityTooltipText: {
            ...
            burns: "burns",
            dotText:
              "{{dotVerb}} for {{dotRatio}} dealt damage over {{dotDuration}}. ",
            pierceText: "{{pierceChance}} chance to pierce. ",
            stunText:
              "{{stunChance}} chance to stun for {{stunDuration}}. ",
            blindText:
              "{{blindChance}} chance to blind for {{blindDuration}}. ",
            silenceText:
              "{{silenceChance}} chance to silence for {{silenceDuration}}. ",
            damageHealReviveEffectText:
              "{{effectType}} {{effectTarget}}{{accuracyBonusText}} for {{baseDamageFlat}}{{maybePlus}}{{baseDamageRatio}} {{combatStyle}} damage{{asDamageType}}. {{dotText}}{{pierceText}}{{stunText}}{{blindText}}{{silenceText}}",
            spendHpEffectText: "Costs {{hpCost}} of current HP. ",
            buffEffectText:
              "{{increaseOrDecrease}} {{targetType}} {{buffName}} by {{boostText}} for {{duration}}. ",
          },
          abilitySlot: {
          ...
          combatTriggersSetting: {
            ...
            setting: "Setting",
            triggerText:
              "{{dependency}} {{condition}} {{comparator}} {{value}}",
            cannotChangeInCombat: "Cannot change in combat",
          },
          buffText: { duration: "Duration", detail: "Detail" },
          buffsTooltip: { bonuses: "Bonuses" },
          communityBuff: {
            durationLabel: "Duration: ",
            durationDefault: "Duration: 1 Minute",
            minutesToNextLevel:
              "Minutes To Add For Next Level: {{minutes}}",
            level: "Level: {{level}}",
            max: " (Max)",
            usableIn: "Usable:",
          ...
          infoNotification: {
            ...
            steamCheckoutRequested:
              "Steam checkout requested. Please wait...",
            ...
            referralJoined:
              "A new player joined with your referral link. Thanks for sharing!",
            newReferralBonus:
          ...
          errorNotification: {
            ...
            requestSpamProtection:
              "Spam Protection: Please do not make actions too quickly",
            nonPublicModMessage:
              "Cannot send mod message to non-public channels",
            nonPublicWarningMessage:
              "Cannot send warning message to non-public channels",
            chatSpamProtection:
              "Spam Protection: Please do not send messages too quickly",
            waitBetweenTradeMessages:
              "Please wait 5 minutes between trade messages",
            waitBetweenRecruitMessages:
              "Please wait 5 minutes between recruit messages",
            cannotWhisperBlocked:
              "Cannot whisper characters blocked by you or who have blocked you",
            stopPartyBattleBeforeSolo:
              "You must stop party battle before starting a solo action",
            cannotEquipLoadoutForAction:
              "Cannot equip loadout for this action",
            ...
            partyGameModeMismatch:
              "This party does not match your game mode",
            partySlotUnavailable: "Party slot no longer available",
            currentPasswordIncorrect: "Current password is incorrect",
            emailAlreadyRegistered:
              "This email address has already been registered on another account",
          },
          guideTooltip: {
            ...
            woodcuttingContent:
              "You can gather logs from different types of trees.Logs are used for crafting various equipments.\nEquipping a hatchet will boost your woodcutting skill.",
            cheesesmithingTitle: "Cheesesmithing",
            cheesesmithingContent:
            ...
            craftingContent:
              "You can craft weapons, offhands, and jewelry.\nEquipping a chisel will boost your crafting skill.",
            tailoringTitle: "Tailoring",
            tailoringContent:
              "You can tailor ranged and magic clothing using raw materials gathered from combat and foraging.\nEquipping a needle will boost your tailoring skill.",
            cookingTitle: "Cooking",
            cookingContent:
              "Food can be used to recover your HP or MP.They can be brought with you to combat.\nEquipping a spatula will boost your cooking skill.",
            ...
            enhancingProtectionContent:
              "If the item's enhancement level exceeds the set minimum protection level, one protection item is used per attempt to ensure only one enhancement level is lost on failure.One protection item is consumed per failure.",
            alchemyCatalystTitle: "Alchemy Catalyst",
            alchemyCatalystContent:
              "Catalyst increases success rate.One catalyst is consumed per success.",
          },
          newsPanel: { news: "News" },
          newsText: {
            17348256e5: {
              heading:
                "Skilling Expansion Part 2 - Celestial Tools and Skilling Outfits",
              content:
          ...
          patchNotesPanel: { patchNotes: "Patch Notes" },
          patchNotesText: {
            17409132e5: {
              heading:
                "Major Patch - Chinese Localization and Final Preparations for Steam Early Access Release",
              content:
        ...
        ...{
          ...
          gameModeDescriptions: {
            standard:
              "The Standard game mode is recommended for new players. There are no feature restrictions. You can only have 1 Standard character",
            ironcow:
              "The Ironcow game mode is for players who enjoys being self-sufficient. You cannot use the marketplace to trade with other players (Exception: buying Cowbells is allowed). You can have multiple Ironcow characters",
            legacy_ironcow: "",
          },
          skillNames: {
          ...
          abilityNames: {
            ...
            "/abilities/arcane_reflection": "Arcane Reflection",
            ...
            "/abilities/aqua_aura": "Aqua Aura",
            "/abilities/sylvan_aura": "Sylvan Aura",
          ...
          abilityDescriptions: {
            ...
            "/abilities/puncture":
              "Punctures the targeted enemy's armor, dealing damage and temporarily reducing its armor",
            "/abilities/penetrating_strike":
              "Strikes the targeted enemy. On each successful hit, will pierce and hit the next enemy.",
            "/abilities/scratch": "Scratches the targeted enemy",
            "/abilities/cleave": "Cleaves all enemies",
            "/abilities/maim":
              "Maims the targeted enemy and causes bleeding",
            "/abilities/crippling_slash":
              "Slashes the targeted enemy and reduce their damage",
            ...
            "/abilities/stunning_blow":
              "Smashes the targeted enemy and has a chance to stun",
            "/abilities/quick_shot":
              "Takes a quick shot at the targeted enemy",
            "/abilities/aqua_arrow":
              "Shoots an arrow made of water at the targeted enemy",
            "/abilities/flame_arrow":
              "Shoots a flaming arrow at the targeted enemy",
            "/abilities/rain_of_arrows":
              "Shoots a rain of arrows on all enemies",
            "/abilities/silencing_shot":
              "Takes a shot at the targeted enemy, temporarily silencing them",
            "/abilities/steady_shot":
              "Takes a shot at the targeted enemy with greatly enhanced accuracy",
            "/abilities/pestilent_shot":
              "Shoots the targeted enemy, dealing damage and decreasing regeneration",
            "/abilities/penetrating_shot":
              "Shoots the targeted enemy. On each successful hit, will pierce and hit the next enemy",
            "/abilities/water_strike":
              "Casts a water strike at the targeted enemy",
            "/abilities/ice_spear":
              "Casts an ice spear at the targeted enemy, dealing damage and reducing attack speed",
            "/abilities/frost_surge":
              "Casts frost surge at all enemies, dealing damage and reducing evasion",
            "/abilities/mana_spring":
              "Casts mana spring at all enemies, dealing damage and increasing ally MP regeneration",
            "/abilities/entangle":
              "Entangles the targeted enemy, dealing damage with chance to stun",
            "/abilities/toxic_pollen":
              "Casts toxic pollen at all enemies, dealing damage and decreasing armor and resistances",
            "/abilities/natures_veil":
              "Cast's a veil over all enemies, dealing damage with a chance to blind",
            ...
            "/abilities/smoke_burst":
              "Casts a smoke burst at the targeted enemy, dealing damage and decreasing their accuracy",
            "/abilities/minor_heal": "Casts minor heal on yourself",
            "/abilities/heal": "Casts heal on yourself",
            "/abilities/quick_aid":
              "Casts heal on the ally with the lowest HP percentage",
            ...
            "/abilities/toughness":
              "Greatly increases armor and resistances temporarily",
            "/abilities/elusiveness":
              "Greatly increases evasion temporarily",
            "/abilities/precision":
              "Greatly increases accuracy temporarily",
            "/abilities/berserk":
              "Greatly increases physical damage temporarily",
            "/abilities/frenzy":
              "Greatly increases attack speed temporarily",
            "/abilities/elemental_affinity":
              "Greatly increases elemental damage temporarily",
            "/abilities/spike_shell": "Gains physical thorns temporarily",
            "/abilities/arcane_reflection":
              "Gains elemental thorns temporarily",
            "/abilities/vampirism": "Gains lifesteal temporarily",
            "/abilities/revive": "Revives a dead ally",
            "/abilities/insanity":
              "Increases damage, attack speed, and cast speed temporarily at the cost of HP",
            "/abilities/invincible":
              "Tremendously increases armor, resistances, and tenacity temporarily",
            "/abilities/fierce_aura":
              "Increases physical amplify and armor for all allies",
            "/abilities/aqua_aura":
              "Increases water amplify and resistance for all allies",
            "/abilities/sylvan_aura":
              "Increases nature amplify and resistance for all allies",
            "/abilities/flame_aura":
              "Increases fire amplify and resistance for all allies",
            "/abilities/speed_aura":
              "Increases attack speed and cast speed for all allies",
            "/abilities/critical_aura":
              "Increases critical rate for all allies",
          ...
          itemDescriptions: {
            ...
            "/items/task_token":
              "Task currency. Spend these in the Task Shop",
            "/items/chimerical_token":
              "Dungeon currency from the Chimerical Den. Spend these in the Shop",
            "/items/sinister_token":
              "Dungeon currency from the Sinister Circus. Spend these in the Shop",
            "/items/enchanted_token":
              "Dungeon currency from the Enchanted Fortress. Spend these in the Shop",
            "/items/cowbell":
              "Premium currency. Buy or spend these in the Cowbell Store",
            "/items/bag_of_10_cowbells":
              "Tradable bag of 10 Cowbells. Once opened, the Cowbells can no longer be sold on the market.",
            "/items/purples_gift":
              "Gifted by Purple after earning task points. Looks like it contains items inside!",
            "/items/small_meteorite_cache":
              "Can be found while gathering. Looks like it contains items inside!",
            "/items/medium_meteorite_cache":
              "Can be found while gathering. Looks like it contains items inside!",
            "/items/large_meteorite_cache":
              "Can be found while gathering. Looks like it contains items inside!",
            "/items/small_artisans_crate":
              "Can be found during production skills. Looks like it contains items inside!",
            "/items/medium_artisans_crate":
              "Can be found during production skills. Looks like it contains items inside!",
            "/items/large_artisans_crate":
              "Can be found during production skills. Looks like it contains items inside!",
            "/items/small_treasure_chest":
              "Can be found from monsters. Looks like it contains items inside!",
            "/items/medium_treasure_chest":
              "Can be found from monsters. Looks like it contains items inside!",
            "/items/large_treasure_chest":
              "Can be found from monsters. Looks like it contains items inside!",
            "/items/chimerical_chest":
              "Received from completion of the Chimerical Den dungeon. Can be opened with Chimerical Chest Key",
            "/items/sinister_chest":
              "Received from completion of the Sinister Circus dungeon. Can be opened with Sinister Chest Key",
            "/items/enchanted_chest":
              "Received from completion of the Enchanted Fortress dungeon. Can be opened with Enchanted Chest Key",
            "/items/blue_key_fragment": "Can be used to craft dungeon keys",
            "/items/green_key_fragment":
              "Can be used to craft dungeon keys",
            ...
            "/items/catalyst_of_coinification":
              "Used in alchemy to increase the coinifying success rate by 15% (multiplicative). One catalyst is consumed on success.",
            "/items/catalyst_of_decomposition":
              "Used in alchemy to increase the decomposition success rate by 15% (multiplicative). One catalyst is consumed on success.",
            "/items/catalyst_of_transmutation":
              "Used in alchemy to increase the transmutation success rate by 15% (multiplicative). One catalyst is consumed on success.",
            "/items/prime_catalyst":
              "Used in alchemy to increase the success rate of any action by 25% (multiplicative). One catalyst is consumed on success.",
            "/items/snake_fang":
              "Material used in smithing Snake Fang Dirk",
            "/items/shoebill_feather":
              "Material used in tailoring Shoebill Shoes",
            "/items/snail_shell":
              "Material used in smithing Snail Shell Helmet",
            "/items/crab_pincer": "Material used in smithing Pincer Gloves",
            "/items/turtle_shell":
              "Material used in smithing Turtle Shell Plate Body or Legs",
            "/items/marine_scale":
              "Material used in tailoring Marine Tunic or Chaps",
            "/items/treant_bark": "Material used in crafting Treant Shield",
            "/items/centaur_hoof":
              "Material used in tailoring Centaur Boots",
            "/items/luna_wing":
              "Material used in tailoring Luna Robe Top or Bottoms",
            "/items/gobo_rag":
              "Material used in tailoring Collector's Boots",
            "/items/goggles": "Material used in smithing Vision Helmet",
            "/items/magnifying_glass":
              "Material used in smithing Vision Shield or tailoring Sighted Bracers",
            "/items/eye_of_the_watcher":
              "Material used in crafting Eye Watch or Watchful Relic",
            "/items/icy_cloth":
              "Material used in tailoring Icy Robe Top or Bottoms",
            "/items/flaming_cloth":
              "Material used in tailoring Flaming Robe Top or Bottoms",
            "/items/sorcerers_sole":
              "Material used in tailoring Sorcerer Boots",
            "/items/chrono_sphere":
              "Material used in tailoring Enchanted Gloves or Chrono Gloves",
            ...
            "/items/black_bear_fluff":
              "Material used in smithing Black Bear Shoes",
            "/items/grizzly_bear_fluff":
              "Material used in smithing Grizzly Bear Shoes",
            "/items/polar_bear_fluff":
              "Material used in smithing Polar Bear Shoes",
            "/items/red_panda_fluff":
              "Material used in tailoring Red Culinary Hat or Fluffy Red Hat",
            "/items/magnet": "Material used in smithing Magnetic Gloves",
            "/items/stalactite_shard":
              "Material used in smithing Stalactite Spear or Spiked Bulwark",
            "/items/living_granite":
              "Material used in smithing Granite Bludgeon or Spiked Bulwark",
            "/items/colossus_core":
              "Material used in smithing Colossus Plate Body or Legs",
            "/items/vampire_fang":
              "Material used in smithing Vampire Fang Dirk or crafting Vampiric Bow",
            "/items/werewolf_claw":
              "Material used in smithing Werewolf Slasher or crafting Vampiric Bow",
            "/items/revenant_anima":
              "Material used in tailoring Revenant Tunic or Chaps",
            "/items/soul_fragment":
              "Material used in crafting Soul Hunter Crossbow",
            "/items/infernal_ember":
              "Material used in crafting Infernal Battlestaff",
            "/items/demonic_core":
              "Material used in smithing Demonic Plate Body or Legs",
            "/items/griffin_leather":
              "Material used in cheesesmithing Griffin Bulwark and tailoring Griffin Tunic or Chaps",
            "/items/manticore_sting":
              "Material used in crafting Manticore Shield",
            "/items/jackalope_antler":
              "Material used in crafting Jackalope Staff",
            "/items/dodocamel_plume":
              "Material used in smithing Dodocamel Gauntlets",
            "/items/griffin_talon":
              "Material used in smithing Griffin Bulwark",
            "/items/acrobats_ribbon":
              "Material used in tailoring Acrobatic Hood",
            "/items/magicians_cloth":
              "Material used in tailoring Magician's Hat",
            "/items/chaotic_chain":
              "Material used in smithing Chaotic Flail",
            "/items/cursed_ball": "Material used in crafting Cursed Bow",
            "/items/royal_cloth":
              "Material used in tailoring Royal Robe Top or Bottoms",
            "/items/knights_ingot":
              "Material used in smithing Knight's Aegis",
            "/items/bishops_scroll":
              "Material used in crafting Bishop's Codex",
            "/items/regal_jewel": "Material used in smithing Regal Sword",
            "/items/sundering_jewel":
              "Material used in crafting Sundering Crossbow",
            "/items/butter_of_proficiency":
              "Material used in producing special skilling tools and outfits",
            "/items/thread_of_expertise":
              "Material used in producing special skilling outfits",
            "/items/branch_of_insight":
              "Material used in producing special skilling tools and outfits",
            "/items/gluttonous_energy":
              "Used for tailoring Gluttonous Pouch",
            "/items/guzzling_energy": "Used for tailoring Guzzling Pouch",
            "/items/milking_essence":
              "Used for brewing milking tea and crafting alchemy catalyst",
            "/items/foraging_essence":
              "Used for brewing foraging tea and crafting alchemy catalyst",
            "/items/woodcutting_essence":
              "Used for brewing woodcutting tea and crafting alchemy catalyst",
            "/items/cheesesmithing_essence":
              "Used for brewing cheesesmithing tea and crafting alchemy catalyst",
            "/items/crafting_essence":
              "Used for brewing crafting tea and crafting alchemy catalyst",
            "/items/tailoring_essence":
              "Used for brewing tailoring tea and crafting alchemy catalyst",
            "/items/cooking_essence":
              "Used for brewing cooking tea and crafting alchemy catalyst",
            "/items/brewing_essence":
              "Used for brewing brewing tea and crafting alchemy catalyst",
            "/items/alchemy_essence":
              "Used for brewing alchemy tea and crafting alchemy catalyst",
            "/items/enhancing_essence":
              "Used for brewing enhancing tea and crafting alchemy catalyst",
            "/items/swamp_essence":
              "Used for enhancing special equipment from Swamp Planet",
            "/items/aqua_essence":
              "Used for enhancing special equipment from Aqua Planet",
            "/items/jungle_essence":
              "Used for enhancing special equipment from Jungle Planet",
            "/items/gobo_essence":
              "Used for enhancing special equipment from Gobo Planet",
            "/items/eyessence":
              "Used for enhancing special equipment from Planet Of The Eyes",
            "/items/sorcerer_essence":
              "Used for enhancing special equipment from Sorcerer's Tower",
            "/items/bear_essence":
              "Used for enhancing special equipment from Bear With It",
            "/items/golem_essence":
              "Used for enhancing special equipment from Golem Cave",
            "/items/twilight_essence":
              "Used for enhancing special equipment from Twilight Zone",
            "/items/abyssal_essence":
              "Used for enhancing special equipment from Infernal Abyss",
            "/items/chimerical_essence":
              "Used for enhancing special equipment from the Chimerical Den",
            "/items/sinister_essence":
              "Used for enhancing special equipment from the Sinister Circus",
            "/items/enchanted_essence":
              "Used for enhancing special equipment from the Enchanted Fortress",
            "/items/task_crystal":
              "Crystals obtained from Purple. They can be used to craft special trinkets.",
            "/items/star_fragment":
              "Fragments with a celestial origin found in Meteorite Caches. They can be used to craft jewelry.",
            ...
            "/items/amethyst":
              "A shiny gem often found from Treasure Chests",
            "/items/moonstone":
              "A shiny gem often found from Treasure Chests",
            "/items/sunstone": "A shiny gem in the shape of the sun.",
            "/items/philosophers_stone":
              "A legendary stone of immense power.",
            ...
            "/items/crushed_philosophers_stone":
              "Used to be a piece of a philosopher's stone",
            "/items/shard_of_protection":
              "Found from Artisan's Crates. They are used for crafting Mirror of Protection",
            "/items/mirror_of_protection":
              "A rare artifact that functions as a copy of any equipment for enhancing protection",
          },
          itemCategoryNames: {
          ...
          combatTriggerConditionNames: {
            ...
            "/combat_trigger_conditions/number_of_dead_units":
              "# of Dead Units",
            "/combat_trigger_conditions/aqua_aura_water_amplify":
              "Aqua Aura (Water Amplify)",
            "/combat_trigger_conditions/aqua_aura_water_resistance":
              "Aqua Aura (Water Resistance)",
            "/combat_trigger_conditions/arcane_reflection":
              "Arcane Reflection",
            ...
            "/combat_trigger_conditions/crippling_slash":
              "Crippling Slash Debuff",
            "/combat_trigger_conditions/critical_coffee_damage":
              "Critical Coffee (Damage)",
            "/combat_trigger_conditions/critical_coffee_rate":
              "Critical Coffee (Rate)",
            "/combat_trigger_conditions/critical_aura": "CriticalAura",
            ...
            "/combat_trigger_conditions/elemental_affinity_fire_amplify":
              "Elemental Affinity (Fire Amplify)",
            "/combat_trigger_conditions/elemental_affinity_nature_amplify":
              "Elemental Affinity (Nature Amplify)",
            "/combat_trigger_conditions/elemental_affinity_water_amplify":
              "Elemental Affinity (Water Amplify)",
            "/combat_trigger_conditions/elusiveness": "Elusiveness",
            "/combat_trigger_conditions/fierce_aura_armor":
              "Fierce Aura (Armor)",
            "/combat_trigger_conditions/fierce_aura_physical_amplify":
              "Fierce Aura (Physical Amplify)",
            "/combat_trigger_conditions/flame_aura_fire_amplify":
              "Flame Aura (Fire Amplify)",
            "/combat_trigger_conditions/flame_aura_fire_resistance":
              "Flame Aura (Fire Resistance)",
            ...
            "/combat_trigger_conditions/insanity_attack_speed":
              "Insanity (Attack Speed)",
            "/combat_trigger_conditions/insanity_cast_speed":
              "Insanity (Cast Speed)",
            "/combat_trigger_conditions/insanity_damage":
              "Insanity (Damage)",
            "/combat_trigger_conditions/intelligence_coffee_mp_regen":
              "Intelligence Coffee (MP Regen)",
            "/combat_trigger_conditions/intelligence_coffee_max_mp":
              "Intelligence Coffee (Max MP)",
            "/combat_trigger_conditions/invincible_armor":
              "Invincible (Armor)",
            "/combat_trigger_conditions/invincible_fire_resistance":
              "Invincible (Fire Resistance)",
            "/combat_trigger_conditions/invincible_nature_resistance":
              "Invincible (Nature Resistance)",
            "/combat_trigger_conditions/invincible_tenacity":
              "Invincible (Tenacity)",
            "/combat_trigger_conditions/invincible_water_resistance":
              "Invincible (Water Resistance)",
            ...
            "/combat_trigger_conditions/pestilent_shot_hp_regen":
              "Pestilent Shot Debuff (HP Regen)",
            "/combat_trigger_conditions/pestilent_shot_mp_regen":
              "Pestilent Shot Debuff (MP Regen)",
            "/combat_trigger_conditions/power_coffee": "Power Coffee",
            ...
            "/combat_trigger_conditions/speed_aura_attack_speed":
              "Speed Aura (Attack Speed)",
            "/combat_trigger_conditions/speed_aura_cast_speed":
              "Speed Aura (Cast Speed)",
            "/combat_trigger_conditions/spike_shell": "Spike Shell",
            "/combat_trigger_conditions/stamina_coffee_hp_regen":
              "Stamina Coffee (HP Regen)",
            "/combat_trigger_conditions/stamina_coffee_max_hp":
              "Stamina Coffee (Max HP)",
            "/combat_trigger_conditions/stun_status": "Stun Status",
            "/combat_trigger_conditions/swiftness_coffee":
              "Swiftness Coffee",
            "/combat_trigger_conditions/sylvan_aura_healing_amplify":
              "Sylvan Aura (Healing Amplify)",
            "/combat_trigger_conditions/sylvan_aura_nature_amplify":
              "Sylvan Aura (Nature Amplify)",
            "/combat_trigger_conditions/sylvan_aura_nature_resistance":
              "Sylvan Aura (Nature Resistance)",
            ...
            "/combat_trigger_conditions/toughness_nature_resistance":
              "Toughness (Nature Resistance)",
            "/combat_trigger_conditions/toughness_water_resistance":
              "Toughness (Water Resistance)",
            "/combat_trigger_conditions/toxic_pollen_armor":
              "Toxic Pollen Debuff (Armor)",
            "/combat_trigger_conditions/toxic_pollen_fire_resistance":
              "Toxic Pollen Debuff (Fire Resistance)",
            "/combat_trigger_conditions/toxic_pollen_nature_resistance":
              "Toxic Pollen Debuff (Nature Resistance)",
            "/combat_trigger_conditions/toxic_pollen_water_resistance":
              "Toxic Pollen Debuff (Water Resistance)",
          ...
          actionNames: {
            ...
            "/actions/tailoring/royal_water_robe_bottoms_from_nature":
              "Royal Water Robe Bottoms (From Nature)",
            "/actions/tailoring/royal_water_robe_bottoms_from_fire":
              "Royal Water Robe Bottoms (From Fire)",
            "/actions/tailoring/royal_nature_robe_bottoms":
              "Royal Nature Robe Bottoms",
            "/actions/tailoring/royal_nature_robe_bottoms_from_water":
              "Royal Nature Robe Bottoms (From Water)",
            "/actions/tailoring/royal_nature_robe_bottoms_from_fire":
              "Royal Nature Robe Bottoms (From Fire)",
            "/actions/tailoring/royal_fire_robe_bottoms":
              "Royal Fire Robe Bottoms",
            "/actions/tailoring/royal_fire_robe_bottoms_from_water":
              "Royal Fire Robe Bottoms (From Water)",
            "/actions/tailoring/royal_fire_robe_bottoms_from_nature":
              "Royal Fire Robe Bottoms (From Nature)",
            "/actions/tailoring/royal_water_robe_top":
              "Royal Water Robe Top",
            "/actions/tailoring/royal_water_robe_top_from_nature":
              "Royal Water Robe Top (From Nature)",
            "/actions/tailoring/royal_water_robe_top_from_fire":
              "Royal Water Robe Top (From Fire)",
            "/actions/tailoring/royal_nature_robe_top":
              "Royal Nature Robe Top",
            "/actions/tailoring/royal_nature_robe_top_from_water":
              "Royal Nature Robe Top (From Water)",
            "/actions/tailoring/royal_nature_robe_top_from_fire":
              "Royal Nature Robe Top (From Fire)",
            "/actions/tailoring/royal_fire_robe_top": "Royal Fire Robe Top",
            "/actions/tailoring/royal_fire_robe_top_from_water":
              "Royal Fire Robe Top (From Water)",
            "/actions/tailoring/royal_fire_robe_top_from_nature":
              "Royal Fire Robe Top (From Nature)",
            ...
            "/actions/brewing/power_coffee": "Power Coffee",
            ...
            "/actions/brewing/super_power_coffee": "Super Power Coffee",
            ...
            "/actions/brewing/ultra_power_coffee": "Ultra Power Coffee",
            ...
            "/actions/combat/smelly_planet_elite": "Smelly Planet (Elite)",
            ...
            "/actions/combat/swamp_planet_elite": "Swamp Planet (Elite)",
            ...
            "/actions/combat/aqua_planet_elite": "Aqua Planet (Elite)",
            ...
            "/actions/combat/jungle_planet_elite": "Jungle Planet (Elite)",
            ...
            "/actions/combat/gobo_planet_elite": "Gobo Planet (Elite)",
            ...
            "/actions/combat/bear_with_it_elite": "Bear With It (Elite)",
            ...
            "/actions/combat/golem_cave_elite": "Golem Cave (Elite)",
            ...
            "/actions/combat/twilight_zone_elite": "Twilight Zone (Elite)",
          ...
          buffTypeNames: {
            ...
            "/buff_types/power_level": "Power Level",
          ...
          buffTypeDescriptions: {
            ...
            "/buff_types/efficiency":
              "Chance of repeating the action instantly",
            "/buff_types/alchemy_success":
              "Multiplicative bonus to success rate while alchemizing",
            "/buff_types/enhancing_success":
              "Multiplicative bonus to success rate while enhancing",
            "/buff_types/action_speed":
              "Decreases time cost for the action",
            "/buff_types/task_action_speed":
              "Decreases time cost for task actions",
            ...
            "/buff_types/gourmet":
              "Chance to produce an additional item for free",
            "/buff_types/wisdom": "Increases experience gained",
            "/buff_types/processing":
              "Chance to instantly convert gathered resource into processed material (cheese, fabric, and lumber)",
            "/buff_types/artisan":
              "Reduces required materials during production",
            "/buff_types/blessed":
              "Chance to gain +2 instead of +1 on enhancing success",
            "/buff_types/action_level":
              "Increases required levels for the action",
            ...
            "/buff_types/power_level": "Buffs power level",
            ...
            "/buff_types/physical_thorns":
              "Reflects a percentage of your armor as damage back to the attacker",
            ...
            "/buff_types/threat":
              "Increases chance of being targeted in combat",
            "/buff_types/combat_drop_rate":
              "Increases drop rate of combat loot",
            "/buff_types/combat_drop_quantity":
              "Increases quantity of combat loot",
          },
          buffTypeDebuffDescriptions: {
            "/buff_types/gathering": "Decreases gathering quantity",
            "/buff_types/efficiency":
              "Lowers chance of repeating the action instantly",
            "/buff_types/alchemy_success":
              "Multiplicative penalty to success rate while alchemizing",
            "/buff_types/enhancing_success":
              "Multiplicative penalty to success rate while enhancing",
            "/buff_types/action_speed":
              "Increases time cost for the action",
            "/buff_types/task_action_speed":
              "Increases time cost for task actions",
            ...
            "/buff_types/gourmet":
              "Lowers chance to produce an additional item for free",
            "/buff_types/wisdom": "Decreases experience gained",
            "/buff_types/processing":
              "Lowers chance to convert gathered resource into processed material (cheese, fabric, and lumber)",
            "/buff_types/artisan":
              "Increases required materials during production",
            "/buff_types/blessed":
              "Lowers chance to gain +2 instead of +1 on enhancing success",
            "/buff_types/action_level":
              "Decreases required levels for the action",
            ...
            "/buff_types/power_level": "Debuffs power level",
            ...
            "/buff_types/tenacity":
              "Increases chance of being blinded, silenced, or stunned",
            "/buff_types/hp_regen": "Decreases HP regeneration",
            "/buff_types/mp_regen": "Decreases MP regeneration",
            "/buff_types/threat":
              "Decreases chance of being targeted in combat",
            "/buff_types/combat_drop_rate":
              "Decreases drop rate of combat loot",
            "/buff_types/combat_drop_quantity":
              "Decreases quantity of combat loot",
          },
          houseRoomNames: {
          ...
          cowbellBundleNames: {
            "/cowbell_bundles/cowbells_500": "500 Cowbells",
            "/cowbell_bundles/cowbells_1050": "1050 Cowbells",
            "/cowbell_bundles/cowbells_2700": "2700 Cowbells",
            "/cowbell_bundles/cowbells_5500": "5500 Cowbells",
            "/cowbell_bundles/cowbells_11500": "11500 Cowbells",
          },
          buyableUpgradeNames: {
            "/buyable_upgrades/offline_hour_cap_1":
              "+1 Hour Offline Progress",
            "/buyable_upgrades/offline_hour_cap_2":
              "+1 Hour Offline Progress",
            "/buyable_upgrades/offline_hour_cap_3":
              "+1 Hour Offline Progress",
            "/buyable_upgrades/offline_hour_cap_4":
              "+1 Hour Offline Progress",
          ...
          chatIconNames: {
            ...
            "/chat_icons/spring_festival_lantern":
      ...
      translation: {
        ...{
          ...
          home: {
            ...
            title:
              "$t(global.gameName) - \u591a\u4eba\u653e\u7f6e\u6e38\u620f - \u6536\u96c6\u3001\u5236\u4f5c\u3001\u6218\u6597\u3001\u4ea4\u6613\uff0c\u8fd8\u6709\u66f4\u591a\u7cbe\u5f69\uff01",
            subtitle: "\u591a\u4eba\u653e\u7f6eRPG",
            bannerText:
              "\u8e0f\u4e0a\u4e00\u6bb5\u7a7f\u8d8a$t(global.gameName)\u7684\u65c5\u7a0b\uff0c\u8fd9\u662f\u4e00\u6b3e\u72ec\u7279\u7684\u591a\u4eba\u653e\u7f6e\u6e38\u620f\u3002\u65e0\u8bba\u4f60\u559c\u6b22\u6536\u96c6\u8d44\u6e90\u3001\u5236\u4f5c\u7269\u54c1\uff0c\u8fd8\u662f\u53c2\u4e0e\u4e0e\u5916\u661f\u602a\u7269\u7684\u53f2\u8bd7\u6218\u6597\uff0c\u8fd9\u91cc\u90fd\u6709\u5c5e\u4e8e\u4f60\u7684\u4e50\u8da3\uff01\u4f60\u53ef\u4ee5\u6c89\u6d78\u5728\u6211\u4eec\u7e41\u8363\u7684\u793e\u533a\u4e2d\uff0c\u5728\u73a9\u5bb6\u9a71\u52a8\u7684\u5e02\u573a\u4e2d\u4ea4\u6613\u7269\u54c1\uff0c\u4e0e\u670b\u53cb\u7ec4\u5efa\u516c\u4f1a\u3001\u7545\u804a\u4ea4\u6d41\uff0c\u751a\u81f3\u51b2\u51fb\u6392\u884c\u699c\u5dc5\u5cf0\uff01",
            testServer: "\u6d4b\u8bd5\u670d\u52a1\u5668",
            activePlayerCount:
              "\u5f53\u524d\u6709 {{count}} \u540d\u6d3b\u8dc3\u73a9\u5bb6\uff01",
            showcases: {
          ...
          auth: {
            ...
            serverError: {
              title: "\u670d\u52a1\u5668\u6682\u65f6\u79bb\u7ebf",
              message:
                "\u6e38\u620f\u670d\u52a1\u5668\u5f53\u524d\u56e0\u66f4\u65b0\u3001\u7ef4\u62a4\u6216\u670d\u52a1\u5668\u95ee\u9898\u800c\u79bb\u7ebf\u3002\u8bf7\u5237\u65b0\u9875\u9762\u5e76\u57285-10\u5206\u949f\u540e\u91cd\u8bd5\u3002",
            },
            thirdPartyCookieMessage: {
              title: "\u767b\u5f55",
              message:
                "\u4f60\u7684\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u7b2c\u4e09\u65b9Cookie\uff0c\u8fd9\u662f\u5728iframe\u5185\u73a9\u6e38\u620f\u6240\u5fc5\u9700\u7684\u3002\u8bf7\u542f\u7528\u7b2c\u4e09\u65b9Cookie\u6216\u4ece<a href='https://www.milkywayidle.com' target='_blank'>www.milkywayidle.com</a>\u8fdb\u884c\u6e38\u620f\u3002",
            },
            welcomeBack: {
              title: "\u6b22\u8fce\u56de\u6765\uff01",
              logout: "\u9000\u51fa\u767b\u9646",
            },
            buttons: { enterGame: "\u8fdb\u5165\u6e38\u620f" },
            confirmationMessages: {
              guestWarning:
                "\u8b66\u544a: \u8bbf\u5ba2\u8d26\u6237\u53ea\u80fd\u901a\u8fc7\u8bbe\u7f6e\u4e2d\u7684\u8bbf\u5ba2\u5bc6\u7801\u518d\u6b21\u767b\u5f55\u3002",
              logoutConfirmation:
                "\u4f60\u786e\u5b9a\u8981\u9000\u51fa\u767b\u9646\u5417\uff1f",
            },
            shared: {
              agreeToRulesLabel:
                "\u6211\u540c\u610f<termsLink>\u300a\u4f7f\u7528\u6761\u6b3e\u300b</termsLink>\u3001<privacyPolicyLink>\u300a\u9690\u79c1\u653f\u7b56\u300b</privacyPolicyLink>\u3001\u548c<gameRulesLink>\u300a\u6e38\u620f\u89c4\u5219\u300b</gameRulesLink>",
              overAge13Label:
                "\u6211\u5e74\u6ee113\u5c81\u6216\u4ee5\u4e0a",
              errors: {
                agreeToRulesError:
          ...
          forgotPassword: {
            title: "\u5fd8\u8bb0\u5bc6\u7801",
            infoMessage:
              "\u5982\u679c\u4f60\u7684\u5e10\u6237\u5df2\u4f7f\u7528\u6709\u6548\u7535\u5b50\u90ae\u4ef6\u6ce8\u518c\uff0c\u4f60\u5c06\u6536\u5230\u4e00\u5c01\u5305\u542b\u91cd\u7f6e\u8bf4\u660e\u7684\u5bc6\u7801\u91cd\u7f6e\u90ae\u4ef6\u3002(\u53ef\u80fd\u9700\u8981\u68c0\u67e5\u5783\u573e\u90ae\u4ef6\u6587\u4ef6\u5939)",
            emailLabel: "\u7535\u5b50\u90ae\u4ef6",
            resetPasswordButton: "\u91cd\u7f6e\u5bc6\u7801",
            backToLogin: "\u8fd4\u56de\u767b\u5f55",
            successMessage:
              "\u5982\u679c\u8be5\u7535\u5b50\u90ae\u4ef6\u5730\u5740\u4e0e\u5e10\u6237\u5173\u8054\uff0c\u5df2\u53d1\u9001\u7535\u5b50\u90ae\u4ef6\u3002",
            errors: {
              emailEmptyError:
                "\u7535\u5b50\u90ae\u4ef6\u4e0d\u80fd\u4e3a\u7a7a",
              invalidEmailError:
          ...
          playFromKongregate: {
            ...
            noAccountMessage:
              "\u4f60\u5fc5\u987b\u62e5\u6709\u4e00\u4e2aKongregate\u5e10\u6237\u624d\u80fd\u8fdb\u884c\u6e38\u620f\u3002",
            registerButton: "\u6ce8\u518c",
            signInInfo:
              "\u767b\u5f55$t(global.gameName)\u3002\u5982\u679c\u662f\u521d\u6b21\u6e38\u73a9\uff0c\u53ef\u521b\u5efa\u65b0\u5e10\u6237\uff01",
            signInButton: "\u4eceKongregate\u767b\u5f55",
          },
          loginWithSteam: {
            signInTitle: "\u4eceSteam\u767b\u5f55\u6e38\u620f",
            signInInfo:
              "\u4f7f\u7528\u4f60\u7684Steam\u5e10\u6237\u5f00\u59cb\u73a9$t(global.gameName)\uff01",
            signInButton: "\u4eceSteam\u767b\u5f55",
            linkAccountTitle:
              "\u5df2\u6709$t(global.gameName)\u5e10\u6237\uff1f",
            linkAccountInfo:
              "\u5982\u679c\u4f60\u4e4b\u524d\u73a9\u8fc7\u7f51\u9875\u7248$t(global.gameName)\uff0c\u53ef\u4ee5\u5c06\u73b0\u6709\u5e10\u6237\u4e0eSteam\u7ed1\u5b9a\u3002",
            linkAccountButton:
              "\u6709\uff0c\u7ed1\u5b9a\u6211\u7684\u5e10\u6237",
            createAccountButton:
              "\u6ca1\u6709\uff0c\u521b\u5efa\u65b0\u5e10\u6237",
            steamAuthTicketError:
              "\u65e0\u6cd5\u83b7\u53d6Steam\u8eab\u4efd\u9a8c\u8bc1\u7968\u636e\u3002\u8bf7\u91cd\u65b0\u542f\u52a8Steam\u5e76\u91cd\u8bd5\u3002",
          },
          characterSelectPage: {
          ...
          gamePage: {
            disconnectedFromServer:
              "\u4e0e\u670d\u52a1\u5668\u65ad\u5f00\u8fde\u63a5...",
            bannedMessage:
              '\u4f60\u88ab\u7981\u7528\u81f3 {{banExpireTime}}\u3002\u539f\u56e0: "{{banReason}}"',
            refresh: "\u5237\u65b0",
            attemptingToConnect:
              "\u6b63\u5728\u8fde\u63a5\u5230\u670d\u52a1\u5668...",
            loadingTitle: "\u52a0\u8f7d\u4e2d - $t(global.gameName)",
            disconnectedTitle:
              "\u5df2\u65ad\u5f00\u8fde\u63a5 - $t(global.gameName)",
            guestLogoutWarning:
              "\u8b66\u544a: \u8bbf\u5ba2\u5e10\u6237\u53ea\u80fd\u901a\u8fc7\u8bbe\u7f6e\u4e2d\u7684\u8bbf\u5ba2\u5bc6\u7801\u518d\u6b21\u767b\u5f55\u3002",
            logoutConfirmation:
              "\u4f60\u786e\u5b9a\u8981\u9000\u51fa\u767b\u9646\u5417\uff1f",
            refreshPrompt: " \u8bf7\u5237\u65b0\u3002",
            gameServerRestarted:
          ...
          header: {
            ...
            protectEnhance:
              "\u4fdd\u62a4: +{{enhancingProtectionMinLevel}}",
          },
          actionProgressBar: {
            fighting: "\u6218\u6597\u4e2d",
          ...
          navigationBar: {
            ...
            alchemyTooltip: "\u83dc\u5c31\u591a\u70bc",
            enhancingTooltip:
              "+5\u9760\u52aa\u529b\uff0c+10\u9760\u8fd0\u6c14\uff0c+15\u662f\u5947\u8ff9\uff0c+20\u662f\u547d\u8fd0",
            combatTooltip:
              "\u4e0e\u602a\u7269\u6218\u6597\u3002\u4f60\u7684\u6218\u6597\u7b49\u7ea7\u4ee3\u8868\u4e86\u57fa\u4e8e\u5404\u4e2a\u6218\u6597\u6280\u80fd\u7b49\u7ea7\u7ec4\u5408\u7684\u7efc\u5408\u6218\u6597\u6548\u679c\u3002",
            shopTooltip:
              "\u4ece\u4f9b\u5e94\u5546\u5904\u8d2d\u4e70\u7269\u54c1\u3002",
            cowbellStoreTooltip:
              "\u8d2d\u4e70\u548c\u4f7f\u7528\u725b\u94c3\u3002",
            ...
            settingsTooltip:
              "\u66f4\u65b0\u5e10\u6237\u4fe1\u606f\u548c\u5176\u4ed6\u8bbe\u7f6e\u3002",
            staminaTooltip:
              "\u6bcf\u7ea7+10\u751f\u547d\u4e0a\u9650\u3002\u4e3b\u8981\u901a\u8fc7\u627f\u53d7\u4f24\u5bb3\u83b7\u5f97\u7ecf\u9a8c\uff0c\u7a0d\u5fae\u901a\u8fc7\u907f\u514d\u4f24\u5bb3\u83b7\u5f97\u7ecf\u9a8c\u3002",
            intelligenceTooltip:
              "\u6bcf\u7ea7+10\u6cd5\u529b\u4e0a\u9650\u3002\u4f7f\u7528\u6280\u80fd\u6d88\u8017\u6cd5\u529b\u65f6\u83b7\u5f97\u7ecf\u9a8c\u3002",
            attackTooltip:
              "\u589e\u52a0\u4f60\u7684\u8fd1\u6218\u7cbe\u51c6\u5ea6\u548c\u57fa\u7840\u653b\u51fb\u901f\u5ea6\u3002\u9020\u6210\u8fd1\u6218\u4f24\u5bb3\u65f6\u83b7\u5f97\u7ecf\u9a8c\uff0c\u523a\u51fb\u83b7\u5f97\u66f4\u591a\u7ecf\u9a8c\uff0c\u949d\u51fb\u83b7\u5f97\u8f83\u5c11\u7ecf\u9a8c\u3002",
            powerTooltip:
              "\u589e\u52a0\u4f60\u7684\u8fd1\u6218\u4f24\u5bb3\u3002\u9020\u6210\u8fd1\u6218\u4f24\u5bb3\u65f6\u83b7\u5f97\u7ecf\u9a8c\uff0c\u949d\u51fb\u83b7\u5f97\u66f4\u591a\u7ecf\u9a8c\uff0c\u523a\u51fb\u83b7\u5f97\u8f83\u5c11\u7ecf\u9a8c\u3002",
            defenseTooltip:
              "\u589e\u52a0\u4f60\u7684\u95ea\u907f\u3001\u62a4\u7532\u548c\u5143\u7d20\u6297\u6027\u3002\u8eb2\u907f\u6216\u51cf\u8f7b\u4f24\u5bb3\u65f6\u83b7\u5f97\u7ecf\u9a8c\u3002",
            rangedTooltip:
              "\u589e\u52a0\u4f60\u7684\u8fdc\u7a0b\u7cbe\u51c6\u5ea6\u3001\u8fdc\u7a0b\u4f24\u5bb3\u548c\u9b54\u6cd5\u95ea\u907f\u3002\u8fdc\u7a0b\u653b\u51fb\u53ef\u4ee5\u66b4\u51fb\u3002\u9020\u6210\u8fdc\u7a0b\u4f24\u5bb3\u65f6\u83b7\u5f97\u7ecf\u9a8c\u3002",
            magicTooltip:
              "\u589e\u52a0\u4f60\u7684\u9b54\u6cd5\u7cbe\u51c6\u5ea6\u3001\u9b54\u6cd5\u4f24\u5bb3\u548c\u5143\u7d20\u6297\u6027\u3002\u9020\u6210\u9b54\u6cd5\u4f24\u5bb3\u65f6\u83b7\u5f97\u7ecf\u9a8c\u3002",
            activePlayers: "\u6d3b\u8dc3\u73a9\u5bb6: {{count}}",
            level: "\u7b49\u7ea7: {{count}}",
          ...
          marketplacePanel: {
            ...
            youDontHaveEnoughItems:
              "\u4f60\u6ca1\u6709\u8db3\u591f\u7684\u7269\u54c1",
            youCantAffordThisMany:
              "\u4f60\u4e70\u4e0d\u8d77\u8fd9\u4e48\u591a",
            mustBeAtLeastVendorPrice:
              "\u5fc5\u987b\u81f3\u5c11\u4e3a\u5546\u4eba\u4ef7\u683c",
            itemFilterPlaceholder: "\u7269\u54c1\u641c\u7d22",
            viewAllItems: "\u67e5\u770b\u6240\u6709\u7269\u54c1",
            viewAllEnhancementLevels:
              "\u67e5\u770b\u6240\u6709\u5f3a\u5316\u7b49\u7ea7",
            refresh: "\u5237\u65b0",
            sell: "\u51fa\u552e",
            buy: "\u8d2d\u4e70",
            ...
            quantityYouCanAfford:
              "\u6570\u91cf (\u4f60\u80fd\u8d1f\u62c5: {{maxQuantity}})",
            quantityAvailableAtPrice:
              "\u6570\u91cf (\u6b64\u4ef7\u683c\u53ef\u7528: {{marketQuantity}})",
            priceBestSellOffer:
              "\u4ef7\u683c (\u6700\u4f73\u51fa\u552e\u62a5\u4ef7: <bestPrice />)",
            priceBestBuyOffer:
              "\u4ef7\u683c (\u6700\u4f73\u8d2d\u4e70\u62a5\u4ef7: <bestPrice />)",
            youGetOrMore:
              "\u83b7\u5f97: {{totalValue}}<coin /> ({{taxRate}}\u7a0e)<br />(\u66f4\u591a\uff0c\u5982\u679c\u6709\u66f4\u597d\u7684\u62a5\u4ef7)",
            youPayOrLess:
              "\u652f\u4ed8: {{totalValue}}<coin /><br />(\u66f4\u5c11\uff0c\u5982\u679c\u6709\u66f4\u597d\u7684\u62a5\u4ef7)",
            listingLimitReached:
              "\u5df2\u8fbe\u5230\u6302\u724c\u9650\u5236",
          ...
          tasksPanel: {
            ...
            blockSlotDescription:
              "\u589e\u52a0\u4e00\u4e2a\u5c4f\u853d\u69fd\u4f4d\uff0c\u5141\u8bb8\u5c4f\u853d\u4e00\u79cd\u975e\u6218\u6597\u4e13\u4e1a\u7684\u65b0\u4efb\u52a1\u3002",
            combatBlockUpgrade: "\u89e3\u9501\u6218\u6597\u5c4f\u853d",
            combatBlockDescription:
              "\u5141\u8bb8\u5c4f\u853d\u6218\u6597\u4efb\u52a1\u3002\u4f60\u9700\u8981\u81f3\u5c11\u4e00\u4e2a\u53ef\u7528\u7684\u5c4f\u853d\u69fd\u4f4d\u624d\u80fd\u4f7f\u7528\u6b64\u529f\u80fd\u3002",
            tutorialIncomplete:
              "\u5b8c\u6210\u4f60\u7684\u6559\u7a0b\u4efb\u52a1\u4ee5\u89e3\u9501\u4efb\u52a1\u680f\u3002<br />\u4f60\u5f53\u524d\u7684\u4efb\u52a1\u53ef\u4ee5\u5728\u9875\u9762\u53f3\u4e0a\u89d2\u627e\u5230\u3002",
            purplesGift:
              "\u5c0f\u7d2b\u725b\u7684\u793c\u7269: {{unclaimedTaskPoints}} / {{claimCost}} \u4efb\u52a1\u79ef\u5206",
            claim: "\u9886\u53d6",
            unreadTasks:
              "\u4f60\u6709 {{count}} \u4e2a\u672a\u8bfb\u4efb\u52a1",
            unreadTasks_one:
          ...
          tutorialQuest: {
            purple: "\u5c0f\u7d2b\u725b",
            welcomeStartText:
              "\u6b22\u8fce\u6765\u5230$t(global.gameName)\u2014\u2014\u4e00\u4e2a\u62e5\u6709\u795e\u5947\u5976\u725b\u7684\u4e16\u754c\uff01<br /><br />\u6211\u662f\u5c0f\u7d2b\u725b\uff0c\u9996\u5e2d\u57f9\u8bad\u5b98\uff0c\u4e5f\u662f\u4f60\u7684\u5bfc\u6e38\uff01<br /><br />\u6211\u4f1a\u7528\u6a59\u8272\u7684\u95ea\u5149\u6765\u5f15\u5bfc\u4f60\u5b8c\u6210\u57f9\u8bad\u3002",
            welcomeButtonText: "\u55e8\uff0c\u5c0f\u7d2b\u725b\uff01",
            milkCowStartText:
              "\u8ba9\u6211\u5148\u5e26\u4f60\u770b\u770b\u6211\u4eec\u795e\u5947\u5976\u725b\u6700\u62ff\u624b\u7684\uff1a\u751f\u4ea7\u795e\u5947\u725b\u5976\uff01\u987a\u4fbf\u8bf4\u4e00\u4e0b\uff0c\u6211\u7684\u8868\u59b9\u6df1\u7d2b\u4e5f\u5728\u8fd9\u91cc\u5de5\u4f5c\u3002\u55e8\uff0c\u6df1\u7d2b\uff01<br /><br />\u9996\u5148\uff0c\u8bd5\u7740\u6536\u96c6\u4e00\u4e9b\u725b\u5976\u3002",
            milkCowCompleteText:
              "\u5e72\u5f97\u597d\uff01\u8fd9\u91cc\u6709\u4e00\u4e9b\u989d\u5916\u7684\u725b\u5976\u548c\u4e00\u628a\u5237\u5b50\u3002\u5237\u4e00\u5237\u5976\u725b\uff0c\u5b83\u4eec\u4f1a\u66f4\u5feb\u4e50\u66f4\u9ad8\u6548\u7684\u4ea7\u5976\uff01",
            smithCheeseStartText:
              "\u8ba9\u6211\u4eec\u7528\u725b\u5976\u5236\u4f5c\u4e00\u4e9b\u5976\u916a\uff01\u8fd9\u4e9b\u7279\u6b8a\u7684\u5976\u916a\u975e\u5e38\u8010\u7528\uff0c\u53ef\u4ee5\u901a\u8fc7\u5976\u916a\u953b\u9020\u505a\u6210\u8bb8\u591a\u6709\u7528\u7684\u4e1c\u897f\uff01",
            smithCheeseCompleteText:
              "\u592a\u597d\u4e86\uff01\u5e26\u4e0a\u4e00\u4e9b\u989d\u5916\u7684\u5976\u916a\u53bb\u5b8c\u6210\u4e0b\u4e00\u4e2a\u4efb\u52a1\u3002",
            smithSwordStartText:
              "\u5976\u916a\u662f\u5236\u4f5c\u5de5\u5177\u3001\u6b66\u5668\u548c\u76d4\u7532\u7684\u91cd\u8981\u8d44\u6e90\u3002\u8ba9\u6211\u6559\u4f60\u5982\u4f55\u5236\u4f5c\u5976\u916a\u5251\u5427\uff01\u6211\u77e5\u9053\u8fd9\u542c\u8d77\u6765\u53ef\u80fd\u6709\u70b9\u4e0d\u53ef\u601d\u8bae\uff0c\u4f46\u8bf7\u76f8\u4fe1\u6211\u3002",
            smithSwordCompleteText:
              "\u771f\u68d2\uff01\u968f\u7740\u4f60\u7684\u5347\u7ea7\uff0c\u4f60\u4e5f\u53ef\u4ee5\u4f7f\u7528\u66f4\u5f3a\u7684\u88c5\u5907\uff01\u8fd8\u53ef\u4ee5\u5236\u4f5c\u5de5\u5177\u6765\u63d0\u9ad8\u4f60\u7684\u6280\u827a\u3002",
            forageFarmlandStartText:
              "\u73b0\u5728\u8ba9\u6211\u4eec\u53bb\u5bfb\u627e\u66f4\u591a\u7684\u8d44\u6e90\u3002\u524d\u5f80\u7fe0\u91ce\u519c\u573a\uff0c\u770b\u770b\u4f60\u80fd\u6536\u96c6\u5230\u4ec0\u4e48\u7269\u54c1\uff01",
            forageFarmlandCompleteText:
              "\u597d\u5feb\uff01\u91c7\u6458\u4e3a\u4f60\u63d0\u4f9b\u4e86\u8bb8\u591a\u6280\u827a\u6240\u9700\u7684\u8d44\u6e90\uff0c\u5305\u62ec\u70f9\u996a\u3001\u51b2\u6ce1\u548c\u7f1d\u7eab\uff01",
            cookDonutStartText:
              "\u662f\u65f6\u5019\u5f00\u59cb\u70f9\u996a\u4e86\uff0c\u7528\u4e00\u4e9b\u9e21\u86cb\u3001\u5c0f\u9ea6\u548c\u7cd6\u505a\u4e00\u4e2a\u7f8e\u5473\u7684\u751c\u751c\u5708\u5427\u3002\u4ec0\u4e48\uff1f\u4f60\u4e0d\u4f1a\u505a\u996d\uff1f\u4f60\u53ef\u4ee5\u5b66\u561b\uff01\u6211\u542c\u8bf4\u5730\u7403\u4e0a\u8fd8\u6709\u53ea\u8001\u9f20\u4f1a\u505a\u996d\u5462\uff0c\u5982\u679c\u5b83\u80fd\u505a\u5230\uff0c\u4f60\u80af\u5b9a\u4e5f\u884c\uff01\u8bd5\u8bd5\u770b\uff01",
            cookDonutCompleteText:
              "\u592a\u68d2\u4e86\uff01\u98df\u7269\u53ef\u4ee5\u5728\u6218\u6597\u4e2d\u6cbb\u6108\u4f60\u3002\u5feb\u62ff\u7740\u8fd9\u4e00\u6253\u514d\u8d39\u7684\u751c\u751c\u5708\uff01",
            fightFlyStartText:
              "\u73b0\u5728\u6211\u60f3\u5e26\u4f60\u53bb\u6211\u4eec\u7684\u90bb\u8fd1\u661f\u7403\u4e4b\u4e00\u2014\u2014\u81ed\u81ed\u661f\u7403\uff01\u6211\u542c\u8bf4\u90a3\u91cc\u6709\u5f88\u591a\u4f1a\u54ac\u4eba\u7684\u82cd\u8747\uff01\u4f60\u6700\u597d\u5e26\u4e0a\u5251\u548c\u4e00\u4e9b\u751c\u751c\u5708\u3002\u6211\u4eec\u51fa\u53d1\u5427\uff01",
            fightFlyCompleteText:
              "\u4e0e\u602a\u517d\u6218\u6597\u53ef\u4ee5\u8d5a\u53d6\u91d1\u5e01\u3001\u8d44\u6e90\u3001\u6280\u80fd\u4e66\uff0c\u751a\u81f3\u7a00\u6709\u7269\u54c1\u3002<br /><br />\u5982\u679c\u4f60\u5728\u6218\u6597\u4e2d\u88ab\u51fb\u5012\uff0c\u4f60\u5c06\u5728150\u79d2\u540e\u6062\u590d\u5e76\u7ee7\u7eed\u6218\u6597\u3002",
            messageTipsStartText:
              "\u770b\u8d77\u6765\u65c5\u884c\u5feb\u7ed3\u675f\u4e86\u3002\u867d\u7136\u8fd8\u6709\u5f88\u591a\u4e1c\u897f\u53ef\u4ee5\u63a2\u7d22\uff0c\u4f46\u522b\u62c5\u5fc3\uff0c\u4f60\u4e0d\u4f1a\u5b64\u5355\uff01\u4e00\u65e6\u4f60\u518d\u5347\u7ea7\u4e00\u70b9\uff0c\u5c31\u53ef\u4ee5\u4e0e\u5176\u4ed6\u73a9\u5bb6\u804a\u5929\u6216\u83b7\u5f97\u5e2e\u52a9\uff01<br /><br />\u4f60\u4e5f\u53ef\u4ee5\u5728\u6211\u4eec\u7684\u73a9\u5bb6\u9a71\u52a8\u7684\u5e02\u573a\u4e2d\u4e70\u5356\u7269\u54c1\uff0c\u9664\u975e\u4f60\u5728\u73a9\u94c1\u725b\u6a21\u5f0f\u3002",
            messageTipsButtonText: "\u597d\u7684",
            messageTips2StartText:
              "\u5728\u6211\u8d70\u4e4b\u524d\uff0c\u8fd8\u6709\u4e00\u4e9b\u63d0\u793a\uff1a<br />- \u6e38\u620f\u6307\u5357\u53ef\u4ee5\u5728\u5de6\u4fa7\u5bfc\u822a\u83dc\u5355\u7684\u5e95\u90e8\u627e\u5230\u3002<br />- \u5373\u4f7f\u4f60\u5904\u4e8e\u79bb\u7ebf\u72b6\u6001\uff0c\u4f60\u4f9d\u7136\u80fd\u7ee7\u7eed\u83b7\u5f9710\u5c0f\u65f6\u79bb\u7ebf\u8fdb\u7a0b (\u53ef\u5347\u7ea7)\u3002<br />- \u7269\u54c1\u3001\u6280\u80fd\u3001\u4e13\u4e1a\u548c\u654c\u4eba\u53ef\u4ee5\u9f20\u6807\u60ac\u505c\uff08\u5728\u79fb\u52a8\u8bbe\u5907\u4e0a\u957f\u6309\uff09\u4ee5\u67e5\u770b\u66f4\u8be6\u7ec6\u4fe1\u606f\u3002<br /><br />\u597d\u7684\uff0c\u6211\u5f97\u8d70\u4e86\uff0c\u662f\u65f6\u5019\u5403\u6211\u7684\u7b2c\u4e8c\u987f\u5348\u9910\u4e86\uff0c\u6211\u53ef\u6709\u56db\u4e2a\u80c3\u8981\u586b\u9971\u5462\u3002\u5feb\u53bb\u63a2\u7d22\u4e16\u754c\u5427\uff01",
            messageTips2ButtonText:
              "\u518d\u89c1\uff0c\u5c0f\u7d2b\u725b\uff01",
          },
          questModal: {
            purple: "\u5c0f\u7d2b\u725b",
          ...
          skillActionDetail: {
            ...
            selectAlchemyItem:
              "\u9009\u62e9\u8981\u70bc\u91d1\u7684\u7269\u54c1",
            coinifyInfo:
              "<span>\u70b9\u91d1:</span> \u5c06\u7269\u54c1\u8f6c\u6362\u4e3a\u91d1\u5e01\u3002",
            decomposeInfo:
              "<span>\u5206\u89e3:</span> \u5c06\u7269\u54c1\u8f6c\u6362\u4e3a\u539f\u6750\u6599\u6216\u7cbe\u534e\u3002",
            transmuteInfo:
              "<span>\u8f6c\u5316:</span> \u5c06\u7269\u54c1\u8f6c\u6362\u4e3a\u968f\u673a\u76f8\u5173\u7269\u54c1\u3002",
            invalidCoinifyItem:
              "\u6b64\u7269\u54c1\u65e0\u6cd5\u88ab\u70b9\u91d1",
            invalidDecomposeItem:
              "\u6b64\u7269\u54c1\u65e0\u6cd5\u88ab\u5206\u89e3",
            invalidTransmuteItem:
              "\u6b64\u7269\u54c1\u65e0\u6cd5\u88ab\u8f6c\u5316",
            ...
            selectEnhancingItem:
              "\u9009\u62e9\u8981\u5f3a\u5316\u7684\u88c5\u5907",
            successInfo:
              "<span>\u6210\u529f</span>\u5c06\u4f7f\u7269\u54c1\u7684\u5f3a\u5316\u7b49\u7ea7\u589e\u52a01\u3002",
            failureInfo:
              "<span>\u5931\u8d25</span>\u9664\u975e\u4f7f\u7528\u4fdd\u62a4\u9053\u5177\uff0c\u5c06\u91cd\u7f6e\u5f3a\u5316\u7b49\u7ea7\u4e3a0\u3002",
            targetLevel: "\u76ee\u6807\u7b49\u7ea7",
            protection: "\u4fdd\u62a4",
            protectFromLevel: "\u4fdd\u62a4\u8d77\u59cb\u7b49\u7ea7",
            protectionMinLevelWarning:
              "\u5fc5\u987b\u22652\u624d\u6709\u6548",
            entryKey: "\u5165\u53e3\u94a5\u5319",
            reward: "\u5956\u52b1",
            bosses: "BOSS",
            bossFight:
              "BOSS<br />\u6bcf{{battlesPerBoss}}\u573a<br/>\u4ea4\u6218\u51fa\u73b0",
            monsters: "\u602a\u7269",
            repeat: "\u91cd\u590d",
            gather: "\u91c7\u96c6",
            produce: "\u751f\u4ea7",
          ...
          cowbellStorePanel: {
            ...
            thankYouSupport:
              "\u611f\u8c22\u4f60\u7684\u652f\u6301! \u8d2d\u4e70\u7684\u725b\u94c3\u5c06\u57281\u5206\u949f\u5185\u51fa\u73b0\u5728\u4f60\u7684\u5e93\u5b58\u4e2d\u3002",
            waitForSteamOverlay:
              "\u7b49\u5f85Steam\u53e0\u52a0\u9875\u9762",
            steamOverlayMessage:
              "Steam\u53e0\u52a0\u9875\u9762\u5c06\u81ea\u52a8\u5f39\u51fa\uff0c\u4ee5\u7ee7\u7eed\u4f60\u7684\u8d2d\u4e70\u3002\u8fd9\u901a\u5e38\u9700\u8981\u51e0\u79d2\u949f\uff0c\u4f46\u5076\u5c14\u4e5f\u4f1a\u9700\u8981\u66f4\u957f\u65f6\u95f4\u3002\u4e4b\u540e\u4f60\u53ef\u4ee5\u5173\u95ed\u6b64\u6d88\u606f\u3002",
            continuePayment:
              "\u70b9\u51fb\u7ee7\u7eed\uff0c\u5728\u65b0\u7a97\u53e3\u4e2d\u6253\u5f00\u6211\u4eec\u7684\u652f\u4ed8\u5904\u7406\u5668\u3002",
            guestWarning:
            ...
            buy: "\u8d2d\u4e70",
            cowbellStore: "\u725b\u94c3\u5546\u5e97",
            supporterPointsLabel:
              "\u652f\u6301\u8005\u79ef\u5206: {{points}}",
            famePointsLabel: "\u540d\u8a89\u79ef\u5206: {{points}}",
            buyCowbellsInfo:
              "\u4f60\u53ef\u4ee5\u8d2d\u4e70\u725b\u94c3\u6765\u652f\u6301\u6e38\u620f\u3002\u725b\u94c3\u53ef\u7528\u4e8e\u8d2d\u4e70\u4fbf\u5229\u5347\u7ea7\u3001\u804a\u5929\u56fe\u6807\u3001\u540d\u79f0\u989c\u8272\u3001\u89d2\u8272\u5f62\u8c61\u3001\u89d2\u8272\u670d\u88c5\u3001\u793e\u533a\u589e\u76ca\uff0c\u6216\u8005\u66f4\u6539\u4f60\u7684\u540d\u79f0\u3002",
            testServerFreeCowbellsSteam:
              "\u6d4b\u8bd5\u670d\u52a1\u5668: \u4f60\u53ef\u4ee5\u514d\u8d39\u83b7\u5f97\u725b\u94c3\u3002\u8fd9\u4f7f\u7528Steam\u7684\u6c99\u76d2\u652f\u4ed8\u6a21\u5f0f\uff0c\u4e0d\u4f1a\u5b9e\u9645\u6263\u6b3e\u3002",
            testServerFreeCowbellsStripe:
              "\u6d4b\u8bd5\u670d\u52a1\u5668: \u4f60\u53ef\u4ee5\u514d\u8d39\u83b7\u5f97\u725b\u94c3\uff0c\u8f93\u51654242-4242-4242-4242\u4f5c\u4e3a\u4fe1\u7528\u5361\uff0c\u5176\u5b83\u5b57\u6bb5\u968f\u610f\u8f93\u5165\u3002",
            buyCowbellsNote:
              "\u6ce8\u610f: \u8d2d\u4e70\u7684\u725b\u94c3\u5c06\u4f5c\u4e3a\u725b\u94c3\u888b (\u6bcf\u888b10\u4e2a) \u51fa\u73b0\u5728\u4f60\u7684[\u5e93\u5b58]\u4e2d\uff0c\u53ef\u4ee5\u5728\u5e02\u573a\u4e0a\u51fa\u552e\u7ed9\u5176\u4ed6\u73a9\u5bb6 ({{cowbellTaxRate}}\u91d1\u5e01\u7a0e)\u3002\u4e00\u65e6\u6253\u5f00\u5c31\u4e0d\u53ef\u51fa\u552e\u3002",
            selectCurrency: "\u9009\u62e9\u8d27\u5e01",
            increaseOfflineProgressLimit:
              "\u589e\u52a0\u79bb\u7ebf\u8fdb\u5ea6\u4e0a\u9650",
            increaseMarketListingLimit:
              "\u589e\u52a0\u5e02\u573a\u6302\u724c\u4e0a\u9650",
            increaseActionQueueLimit:
              "\u589e\u52a0\u884c\u52a8\u961f\u5217\u4e0a\u9650",
            increaseLoadoutSlotLimit:
              "\u589e\u52a0\u914d\u88c5\u69fd\u4f4d\u4e0a\u9650",
            increaseTaskSlotLimit:
              "\u589e\u52a0\u4efb\u52a1\u69fd\u4f4d\u4e0a\u9650",
            upgradeLimitsInfo:
              "\u5347\u7ea7\u4f1a\u6c38\u4e45\u589e\u52a0\u4e0a\u9650\u3002\u4f60\u5f53\u524d\u7684\u4e0a\u9650\u53ef\u4ee5\u5728[\u8bbe\u7f6e]\u4e2d\u67e5\u770b\u3002",
            seasonal: "\u5b63\u8282\u6027",
            unlocked: "\u5df2\u89e3\u9501",
            chatIconsInfo:
              "\u804a\u5929\u56fe\u6807\u663e\u793a\u5728\u4f60\u540d\u79f0\u524d\u9762\u3002\u89e3\u9501\u7684\u804a\u5929\u56fe\u6807\u53ef\u4ee5\u5728[\u8bbe\u7f6e]->[\u4e2a\u4eba\u8d44\u6599]\u4e2d\u66f4\u6539\u3002",
            customChatIconInfo:
              "\u8fbe\u523050K\u3001150K\u548c200K\u652f\u6301\u8005\u79ef\u5206\u540e\uff0c\u73a9\u5bb6\u53ef\u4ee5\u4e3a\u6bcf\u4e2a\u8fbe\u5230\u7684\u7b49\u7ea7\u7533\u8bf7\u4e00\u4e2a\u5b9a\u5236\u804a\u5929\u56fe\u6807\u3002\u56fe\u6807\u5fc5\u987b\u7b26\u5408\u6e38\u620f\u4e3b\u9898\uff0c\u53ef\u4ee5\u901a\u8fc7Discord\u4e0a\u7684#new-ticket\u7533\u8bf7\u3002\u6bcf\u4e2a\u73a9\u5bb6\u6700\u591a\u53ef\u4ee5\u7533\u8bf7\u4e09\u4e2a\u5b9a\u5236\u56fe\u6807\u3002",
            nameColorsInfo:
              "\u70b9\u51fb\u4efb\u610f\u989c\u8272\u67e5\u770b\u9884\u89c8\u3002\u89e3\u9501\u7684\u989c\u8272\u53ef\u4ee5\u5728[\u8bbe\u7f6e]->[\u4e2a\u4eba\u8d44\u6599]\u4e2d\u66f4\u6539\u3002",
            customNameColorInfo:
              "\u8fbe\u5230100K\u652f\u6301\u8005\u79ef\u5206\u540e\uff0c\u73a9\u5bb6\u53ef\u4ee5\u7533\u8bf7\u4e00\u4e2a\u5b9a\u5236\u540d\u79f0\u989c\u8272(\u6216\u6e10\u53d8\u6a21\u5f0f)\u3002\u8fd9\u53ef\u4ee5\u901a\u8fc7Discord\u4e0a\u7684#new-ticket\u7533\u8bf7\u3002",
            avatarsInfo:
              "\u70b9\u51fb\u4efb\u610f\u89d2\u8272\u5f62\u8c61\u67e5\u770b\u9884\u89c8\u3002\u89e3\u9501\u7684\u89d2\u8272\u5f62\u8c61\u53ef\u4ee5\u5728[\u8bbe\u7f6e]->[\u4e2a\u4eba\u8d44\u6599]\u4e2d\u66f4\u6539\u3002",
            customAvatarInfo:
              "\u8fbe\u5230250K\u652f\u6301\u8005\u79ef\u5206\u540e\uff0c\u73a9\u5bb6\u53ef\u4ee5\u7533\u8bf7\u4e00\u4e2a\u5b9a\u5236\u89d2\u8272\u5f62\u8c61\u3002\u89d2\u8272\u5f62\u8c61\u8bbe\u8ba1\u5fc5\u987b\u7b26\u5408\u6e38\u620f\u4e3b\u9898\uff0c\u53ef\u4ee5\u901a\u8fc7Discord\u4e0a\u7684#new-ticket\u7533\u8bf7\u3002",
            avatarOutfitsInfo:
              "\u70b9\u51fb\u4efb\u610f\u89d2\u8272\u670d\u88c5\u67e5\u770b\u9884\u89c8\u3002\u89e3\u9501\u7684\u89d2\u8272\u670d\u88c5\u53ef\u4ee5\u5728[\u8bbe\u7f6e]->[\u4e2a\u4eba\u8d44\u6599]\u4e2d\u66f4\u6539\u3002",
            customAvatarOutfitInfo:
              "\u8fbe\u5230350K\u652f\u6301\u8005\u79ef\u5206\u540e\uff0c\u73a9\u5bb6\u53ef\u4ee5\u7533\u8bf7\u4e00\u4e2a\u5b9a\u5236\u89d2\u8272\u670d\u88c5\u3002\u670d\u88c5\u8bbe\u8ba1\u5fc5\u987b\u7b26\u5408\u6e38\u620f\u4e3b\u9898\uff0c\u53ef\u4ee5\u901a\u8fc7Discord\u4e0a\u7684#new-ticket\u7533\u8bf7\u3002",
            communityBuffsInfo:
              "\u793e\u533a\u589e\u76ca\u4f7f\u670d\u52a1\u5668\u4e0a\u6240\u6709\u73a9\u5bb6\u90fd\u53d7\u76ca\u3002\u6bcf\u82b1\u8d39\u4e00\u4e2a\u725b\u94c3\u5728\u793e\u533a\u589e\u76ca\u4e0a\uff0c\u4f60\u5c06\u83b7\u5f971\u4e2a\u540d\u8a89\u79ef\u5206\u3002\u540d\u8a89\u79ef\u5206\u5728\u6392\u884c\u699c\u4e0a\u6392\u540d\u3002",
          ...
          paymentSuccessPage: {
            paymentSuccess: "\u652f\u4ed8\u6210\u529f",
            thankYouMessage:
              "\u611f\u8c22\u4f60\u7684\u652f\u6301\uff01\u8d2d\u4e70\u7684\u725b\u94c3\u5c06\u57281\u5206\u949f\u5185\u51fa\u73b0\u5728\u4f60\u7684\u5e93\u5b58\u4e2d\u3002\u4f60\u53ef\u4ee5\u5173\u95ed\u6b64\u9875\u5e76\u8fd4\u56de\u6e38\u620f\u3002",
          },
          paymentCancelPage: {
          ...
          socialPanel: {
            ...
            referralBonusFirstLevel:
              "\u63a8\u8350\u7684\u73a9\u5bb6\u8fbe\u5230\u4e86\u603b\u7b49\u7ea7 {{level}}",
            referralBonusPurchase:
              "\u63a8\u8350\u7684\u73a9\u5bb6\u8d2d\u4e70\u4e86\u725b\u94c3",
            reward: "\u5956\u52b1: {{quantity}}",
            claim: "\u9886\u53d6",
            referralInstructions:
              "\u5f53\u6709\u4eba\u4f7f\u7528\u4f60\u7684\u63a8\u8350\u94fe\u63a5\u6ce8\u518c\u65f6\uff0c\u4f60\u5c06\u6709\u8d44\u683c\u83b7\u5f97\u4ee5\u4e0b\u5956\u52b1:",
            referralInstructionBullets:
              "<ul><li>\u83b7\u5f97 {{firstLevelCowbells}}<cowbellIcon />\u5982\u679c\u63a8\u8350\u7684\u73a9\u5bb6\u8fbe\u5230\u603b\u7b49\u7ea7 {{firstTotalLevel}}\u3002</li><li>\u989d\u5916\u83b7\u5f97 {{secondLevelCowbells}}<cowbellIcon />\u5982\u679c\u73a9\u5bb6\u8fbe\u5230\u603b\u7b49\u7ea7 {{secondTotalLevel}}\u3002</li><li>\u73a9\u5bb6\u8d2d\u4e70\u7684\u4efb\u4f55\u725b\u94c3\u7684 {{purchaseCowbellPercent}}\u3002</li></ul>",
            referralLinkCopied: "\u94fe\u63a5\u5df2\u590d\u5236",
            copyLink: "\u590d\u5236\u94fe\u63a5",
            referralCount:
              "\u5230\u76ee\u524d\u4e3a\u6b62\uff0c\u5df2\u6709 <span>{{count}}</span> \u540d\u73a9\u5bb6\u901a\u8fc7\u4f60\u7684\u63a8\u8350\u94fe\u63a5\u6ce8\u518c",
            socialTitle: "\u793e\u4ea4",
          },
          guildPanel: {
            overview: "\u6982\u89c8",
            ...
            join: "\u52a0\u5165",
            createGuildInstructions:
              "\u4f60\u53ef\u4ee5\u82b1\u8d395M\u91d1\u5e01\u521b\u5efa\u4e00\u4e2a\u516c\u4f1a\u3002\u516c\u4f1a\u76ee\u524d\u63d0\u4f9b\u4ee5\u4e0b\u529f\u80fd:",
            createGuildInfoBullets:
              "<ul><li>\u516c\u4f1a\u804a\u5929\u9891\u9053\u548c\u516c\u544a\u677f\u3002</li><li>\u5f53\u6210\u5458\u5728\u4efb\u4f55\u4e13\u4e1a\u83b7\u5f97\u7ecf\u9a8c\u65f6\u516c\u4f1a\u4e5f\u5c06\u83b7\u5f97\u7ecf\u9a8c\u5e76\u53ef\u5347\u7ea7\uff0c\u7ecf\u9a8c\u6bd4\u4f8b\u4e3a1:1000\u3002</li><li>{{defaultSlots}} \u4e2a\u6210\u5458\u69fd\u4f4d\uff0c\u6bcf{{levelsPerSlot}}\u7ea7\u516c\u4f1a\u7b49\u7ea7\u589e\u52a01\u4e2a\u989d\u5916\u69fd\u4f4d\u3002</li><li>\u53ef\u4ee5\u5206\u914d\u89d2\u8272: \u4f1a\u957f\u3001\u5c06\u519b\u3001\u5b98\u5458\u3001\u4f1a\u5458\u3002</li></ul>",
            cost5m: "\u8d39\u7528: 5,000,000",
            guildNamePlaceholder: "\u516c\u4f1a\u540d\u79f0",
            createGuild: "\u521b\u5efa\u516c\u4f1a",
            joinGuildInfo:
              "\u4f60\u4e5f\u53ef\u4ee5\u88ab\u9080\u8bf7\u52a0\u5165\u73b0\u6709\u516c\u4f1a\u3002\u4f7f\u7528\u62db\u52df\u804a\u5929\u9891\u9053\u5bfb\u627e\u8981\u52a0\u5165\u7684\u516c\u4f1a\u3002\u6536\u5230\u7684\u9080\u8bf7\u5c06\u663e\u793a\u5728\u4e0b\u65b9\u3002",
            save: "\u4fdd\u5b58",
            edit: "\u4fee\u6539",
            guildLevel: "\u516c\u4f1a\u7b49\u7ea7",
          ...
          chat: {
            generalTip:
              "\u63d0\u793a: \u56fd\u9645\u9891\u9053\u4ec5\u9650\u82f1\u8bed\u8fdb\u884c\u6e38\u620f\u8ba8\u8bba\u548c\u53cb\u597d\u4ea4\u6d41\u3002\u4e3a\u4fdd\u6301\u79ef\u6781\u548c\u76f8\u4e92\u5c0a\u91cd\u7684\u6c14\u6c1b\uff0c\u8bf7\u9075\u5b88<gameRulesLink>\u6e38\u620f\u89c4\u5219</gameRulesLink>\u3002",
            tradeTip:
              "\u63d0\u793a: \u8d38\u6613\u9891\u9053\u7528\u4e8e\u5ba3\u4f20\u7269\u54c1\u4ea4\u6613\u548c\u670d\u52a1\u3002\u8bf7\u4f7f\u7528\u79c1\u804a\u8fdb\u884c\u5bf9\u8bdd\u548c\u8c08\u5224\u3002",
            recruitTip:
              "\u63d0\u793a: \u62db\u52df\u9891\u9053\u7528\u4e8e\u5ba3\u4f20\u516c\u4f1a/\u961f\u4f0d\u62db\u52df\u548c\u5bfb\u627e\u52a0\u5165\u516c\u4f1a/\u961f\u4f0d\u7684\u73a9\u5bb6\u3002\u8bf7\u4f7f\u7528\u79c1\u804a\u8fdb\u884c\u5bf9\u8bdd\u3002",
            beginnerTip:
              "\u63d0\u793a: \u6b22\u8fce\u5728\u6b64\u63d0\u95ee\u6216\u4e0e\u5176\u4ed6\u73a9\u5bb6\u804a\u5929\u3002\u5b9e\u7528\u94fe\u63a5: <gameGuideLink>\u6e38\u620f\u6307\u5357</gameGuideLink>\u548c<gameRulesLink>\u6e38\u620f\u89c4\u5219</gameRulesLink>\u3002",
            whisperTip:
              '\u63d0\u793a: \u4f60\u53ef\u4ee5\u4f7f\u7528\u547d\u4ee4"/w [\u73a9\u5bb6\u540d] [\u6d88\u606f]"\u4e0e\u5176\u4ed6\u73a9\u5bb6\u79c1\u804a\uff0c\u6216\u70b9\u51fb\u73a9\u5bb6\u7684\u540d\u79f0\u5e76\u9009\u62e9\u79c1\u804a\u3002',
            useWhisperCommand: "\u4f7f\u7528 /w \u547d\u4ee4",
            needPlayerName: "\u9700\u8981\u73a9\u5bb6\u540d",
            emptyMessage: "\u6d88\u606f\u4e3a\u7a7a",
            invalidCommand: "\u65e0\u6548\u547d\u4ee4",
            mutedMessage:
              '\u4f60\u88ab\u7981\u8a00\u81f3 {{muteExpireTime}}\u3002\u539f\u56e0: "{{muteReason}}"',
            generalChatRestriction:
              "\u4f60\u9700\u8981\u81f3\u5c11 {{generalChatMinLevel}} \u603b\u7b49\u7ea7\u6216 {{generalChatMinExp}} \u603b\u7ecf\u9a8c\u624d\u80fd\u4f7f\u7528\u56fd\u9645\u804a\u5929",
            chatRestriction:
              "\u4f60\u9700\u8981\u81f3\u5c11 {{chatMinLevel}} \u603b\u7b49\u7ea7\u624d\u80fd\u804a\u5929",
            enterMessagePlaceholder: "\u8f93\u5165\u6d88\u606f...",
            sendButton: "\u53d1\u9001",
            notifyModsConfirmation:
              "\u4f60\u786e\u5b9a\u8981\u901a\u77e5\u7ba1\u7406\u5458\u5417\uff1f\u8fd9\u53ea\u80fd\u7528\u4e8e\u9700\u8981\u7acb\u5373\u5904\u7406\u7684\u7d27\u6025\u95ee\u9898\u3002",
            notifyMods: "\u901a\u77e5\u7ba1\u7406\u5458",
            cancel: "\u53d6\u6d88",
          },
          chatMessage: {
            ...
            moderator: "\u7ba1\u7406\u5458",
            privateModeratorTo:
              "(\u79c1\u5bc6) \u7ba1\u7406\u5458\u5bf9{{receiverName}}\u8bf4",
            toPlayer: "\u5bf9{{receiverName}}\u8bf4",
            messageDeleted: "[\u6d88\u606f\u5df2\u5220\u9664]",
          },
          characterName: { customIcon: "\u5b9a\u5236\u56fe\u6807" },
          textWithLinks: {
            externalLinkWarning:
              "\u4f60\u786e\u5b9a\u8981\u6253\u5f00\u5916\u90e8\u94fe\u63a5\u5417\uff1f",
          },
          ...
          equipmentStatsText: {
            weaken:
              "\u524a\u5f31: \u88ab\u654c\u4eba\u653b\u51fb\u65f6\uff0c\u964d\u4f4e\u654c\u4eba{{value}}\u7cbe\u51c6\u5ea6\uff0c\u6301\u7eed15\u79d2\uff0c\u6700\u591a\u53e0\u52a05\u6b21\u3002",
            parry:
              "\u683c\u6321: {{value}}\u51e0\u7387\u683c\u6321\u654c\u4eba\u7684\u653b\u51fb\uff0c\u907f\u514d\u4f24\u5bb3\u5e76\u7acb\u5373\u81ea\u52a8\u653b\u51fb\u4e00\u6b21\u3002",
            mayhem:
              "\u66b4\u4e71: \u5728\u81ea\u52a8\u653b\u51fb\u672a\u547d\u4e2d\u65f6\uff0c\u6709{{value}}\u51e0\u7387\u81ea\u52a8\u653b\u51fb\u4e0b\u4e00\u4e2a\u654c\u4eba\uff0c\u53ef\u591a\u6b21\u8fde\u7eed\u89e6\u53d1\u3002",
            pierce:
              "\u7a7f\u900f: \u5728\u81ea\u52a8\u653b\u51fb\u547d\u4e2d\u540e\uff0c\u6709{{value}}\u51e0\u7387\u81ea\u52a8\u653b\u51fb\u4e0b\u4e00\u4e2a\u654c\u4eba\uff0c\u53ef\u591a\u6b21\u8fde\u7eed\u89e6\u53d1\u3002",
            curse:
              "\u8bc5\u5492: \u547d\u4e2d\u654c\u4eba\u65f6\uff0c\u4f7f\u5176\u53d7\u5230\u7684\u4f24\u5bb3\u589e\u52a0{{value}}\uff0c\u6301\u7eed15\u79d2\uff0c\u6700\u591a\u53e0\u52a05\u6b21\u3002",
          },
          itemSelector: {
            count: "\u6570\u91cf",
            remove: "\u79fb\u9664",
            itemFilterPlaceholder: "\u7269\u54c1\u641c\u7d22",
            cannotChangeWhileInCombat:
              "\u6218\u6597\u4e2d\u65e0\u6cd5\u66f4\u6539",
          ...
          itemDictionary: {
            ...
            anyWoodcuttingAction:
              "\u4efb\u4f55\u4f10\u6728\u884c\u52a8\u3002",
            anyCheesesmithingAction:
              "\u4efb\u4f55\u5976\u916a\u953b\u9020\u884c\u52a8\u3002",
            ...
            anyEnhancingAction:
              "\u4efb\u4f55\u5f3a\u5316\u884c\u52a8\u3002",
            anyLowLevelGathering:
              "\u4efb\u4f55\u4f4e\u7ea7\u91c7\u96c6\u884c\u52a8\u3002",
            anyMediumLevelGathering:
              "\u4efb\u4f55\u4e2d\u7ea7\u91c7\u96c6\u884c\u52a8\u3002",
            anyHighLevelGathering:
              "\u4efb\u4f55\u9ad8\u7ea7\u91c7\u96c6\u884c\u52a8\u3002",
            anyLowLevelProduction:
              "\u4efb\u4f55\u4f4e\u7ea7\u751f\u4ea7\u3001\u70bc\u91d1\u548c\u5f3a\u5316\u884c\u52a8\u3002",
            anyMediumLevelProduction:
          ...
          abilityTooltipText: {
            ...
            accuracyBonusText: "\u603b\u7cbe\u51c6\u5ea6 {{accuracyBonus}}",
            baseDamageFlat: "{{baseDamageFlat}}HP",
            baseDamageRatio: "{{baseDamageRatio}}",
            ...
            burns: "\u71c3\u70e7",
            dotText:
              "\u4f7f\u76ee\u6807{{dotVerb}}{{dotDuration}}\uff0c\u518d\u9020\u6210\u539f\u653b\u51fb100%\u7684\u4f24\u5bb3\u3002",
            pierceText: "{{pierceChance}}\u7a7f\u900f\u51e0\u7387\u3002",
            stunText:
              "{{stunChance}}\u51e0\u7387\u4f7f\u76ee\u6807\u6655\u7729{{stunDuration}}\u3002",
            blindText:
              "{{blindChance}}\u51e0\u7387\u4f7f\u76ee\u6807\u5931\u660e{{blindDuration}}\u3002",
            silenceText:
              "{{silenceChance}}\u51e0\u7387\u4f7f\u76ee\u6807\u6c89\u9ed8{{silenceDuration}}\u3002",
            damageHealReviveEffectText:
              "{{asDamageType}}{{effectType}}{{effectTarget}}{{accuracyBonusText}}{{baseDamageFlat}}{{maybePlus}}{{baseDamageRatio}}{{combatStyle}}\u4f24\u5bb3\u3002{{dotText}}{{pierceText}}{{stunText}}{{blindText}}{{silenceText}}",
            spendHpEffectText:
              "\u6d88\u8017\u5f53\u524dHP {{hpCost}}\u3002",
            buffEffectText:
              "{{increaseOrDecrease}}{{targetType}}{{buffName}}{{boostText}}\uff0c\u6301\u7eed{{duration}}\u3002",
          },
          abilitySlot: {
          ...
          errorNotification: {
            ...
            characterNotInParty:
              "\u89d2\u8272\u4e0d\u5728\u961f\u4f0d\u4e2d",
            partyNoLongerRecruiting:
              "\u6b64\u961f\u4f0d\u4e0d\u518d\u62db\u52df",
            partyGameModeMismatch:
              "\u6b64\u961f\u4f0d\u4e0e\u4f60\u7684\u6e38\u620f\u6a21\u5f0f\u4e0d\u5339\u914d",
            partySlotUnavailable:
              "\u961f\u4f0d\u69fd\u4f4d\u5df2\u4e0d\u53ef\u7528",
          ...
          guideTooltip: {
            ...
            loadoutsTitle: "\u914d\u88c5",
            loadoutsContent:
              '\u914d\u88c5\u5141\u8bb8\u4f60\u4fdd\u5b58\u5f53\u524d\u7684\u88c5\u5907\u3001\u6d88\u8017\u54c1\u548c\u6280\u80fd\uff0c\u4ee5\u4fbf\u7a0d\u540e\u4e0e\u884c\u52a8\u4e00\u8d77\u81ea\u52a8\u52a0\u8f7d\u3002\u914d\u88c5\u53ef\u4ee5\u7ed1\u5b9a\u5230\u5355\u4e2a\u4e13\u4e1a\u6216"\u6240\u6709\u4e13\u4e1a"\u3002\u9009\u62e9"\u6240\u6709\u4e13\u4e1a"\u5c06\u53ea\u4fdd\u5b58\u88c5\u5907\u3002\n\u5c06\u914d\u88c5\u8bbe\u7f6e\u4e3a\u9ed8\u8ba4\u65f6\uff0c\u5728\u9009\u62e9\u4e0e\u914d\u88c5\u5173\u8054\u7684\u4e13\u4e1a\u4e2d\u7684\u4efb\u4f55\u884c\u52a8\u65f6\u4f1a\u81ea\u52a8\u9009\u62e9\u8be5\u914d\u88c5\u3002',
            enhancingProtectionTitle: "\u5f3a\u5316\u4fdd\u62a4",
            enhancingProtectionContent:
              "\u5982\u679c\u7269\u54c1\u7684\u5f3a\u5316\u7b49\u7ea7\u8d85\u8fc7\u8bbe\u5b9a\u7684\u6700\u4f4e\u4fdd\u62a4\u7b49\u7ea7\uff0c\u6bcf\u6b21\u5c1d\u8bd5\u5c06\u4f7f\u7528\u4fdd\u62a4\u9053\u5177\uff0c\u4ee5\u786e\u4fdd\u5931\u8d25\u65f6\u53ea\u635f\u5931\u4e00\u4e2a\u5f3a\u5316\u7b49\u7ea7\u3002\u4ec5\u5728\u5931\u8d25\u65f6\u6d88\u8017\u4e00\u4e2a\u4fdd\u62a4\u9053\u5177\u3002",
            alchemyCatalystTitle: "\u70bc\u91d1\u50ac\u5316\u5242",
            alchemyCatalystContent:
              "\u50ac\u5316\u5242\u589e\u52a0\u6210\u529f\u7387\u3002\u4ec5\u5728\u6210\u529f\u65f6\u6d88\u8017\u4e00\u4e2a\u50ac\u5316\u5242\u3002",
          },
          newsPanel: { news: "\u65b0\u95fb" },
          newsText: {
            17348256e5: {
          ...
          patchNotesPanel: { patchNotes: "\u66f4\u65b0\u65e5\u5fd7" },
          patchNotesText: {
            17409132e5: {
              heading:
                "\u91cd\u8981\u66f4\u65b0 - \u4e2d\u56fd\u7ffb\u8bd1\u548c\u4e3aSTEAM\u53d1\u5e03\u7684\u6700\u540e\u51c6\u5907",
              content:
        ...
        ...{
          ...
          gameModeDescriptions: {
            standard:
              "\u6807\u51c6\u6e38\u620f\u6a21\u5f0f\u9002\u5408\u65b0\u73a9\u5bb6\uff0c\u6ca1\u6709\u529f\u80fd\u9650\u5236\u3002\u4f60\u53ea\u80fd\u521b\u5efa\u4e00\u4e2a\u6807\u51c6\u89d2\u8272",
            ironcow:
              "\u94c1\u725b\u6e38\u620f\u6a21\u5f0f\u9002\u5408\u559c\u6b22\u81ea\u529b\u66f4\u751f\u7684\u73a9\u5bb6\u3002\u4f60\u4e0d\u80fd\u4f7f\u7528\u5e02\u573a\u4e0e\u5176\u4ed6\u73a9\u5bb6\u4ea4\u6613(\u4f8b\u5916: \u5141\u8bb8\u8d2d\u4e70\u725b\u94c3)\u3002\u4f60\u53ef\u4ee5\u62e5\u6709\u591a\u4e2a\u94c1\u725b\u89d2\u8272",
            legacy_ironcow: "",
          },
          skillNames: {
          ...
          abilityDescriptions: {
            ...
            "/abilities/puncture":
              "\u51fb\u7834\u76ee\u6807\u654c\u4eba\u7684\u62a4\u7532\uff0c\u9020\u6210\u4f24\u5bb3\u5e76\u4e34\u65f6\u964d\u4f4e\u5176\u62a4\u7532",
            "/abilities/penetrating_strike":
              "\u523a\u5411\u76ee\u6807\u654c\u4eba\uff0c\u5982\u679c\u547d\u4e2d\uff0c\u5219\u8d2f\u7a7f\u5e76\u523a\u5411\u4e0b\u4e00\u4e2a\u654c\u4eba",
            ...
            "/abilities/pestilent_shot":
              "\u5bf9\u76ee\u6807\u654c\u4eba\u5c04\u51fb\uff0c\u5e76\u51cf\u5c11HP/MP\u6062\u590d",
            "/abilities/penetrating_shot":
              "\u5c04\u51fb\u76ee\u6807\u654c\u4eba\uff0c\u5982\u679c\u547d\u4e2d\uff0c\u5219\u8d2f\u7a7f\u5e76\u5c04\u5411\u4e0b\u4e00\u4e2a\u654c\u4eba",
            "/abilities/water_strike":
              "\u5bf9\u76ee\u6807\u654c\u4eba\u4f7f\u7528\u6d41\u6c34\u51b2\u51fb",
            "/abilities/ice_spear":
              "\u5bf9\u76ee\u6807\u654c\u4eba\u6295\u63b7\u51b0\u77db\uff0c\u9020\u6210\u4f24\u5bb3\u5e76\u964d\u4f4e\u5176\u653b\u51fb\u901f\u5ea6",
            "/abilities/frost_surge":
              "\u5bf9\u6240\u6709\u654c\u4eba\u65bd\u653e\u51b0\u971c\u7206\u88c2,\u9020\u6210\u4f24\u5bb3\u5e76\u51cf\u5c11\u95ea\u907f",
            "/abilities/mana_spring":
              "\u5bf9\u6240\u6709\u654c\u4eba\u91ca\u653e\u6cd5\u529b\u55b7\u6cc9\uff0c\u9020\u6210\u4f24\u5bb3\u5e76\u589e\u52a0\u53cb\u65b9MP\u6062\u590d",
            "/abilities/entangle":
              "\u7f20\u7ed5\u76ee\u6807\u654c\u4eba\uff0c\u9020\u6210\u4f24\u5bb3\u5e76\u6709\u51e0\u7387\u4f7f\u5176\u7729\u6655",
            "/abilities/toxic_pollen":
              "\u5bf9\u6240\u6709\u654c\u4eba\u65bd\u653e\u5267\u6bd2\u7c89\u5c18\uff0c\u9020\u6210\u4f24\u5bb3\u5e76\u51cf\u5c11\u62a4\u7532\u548c\u9b54\u6297",
            "/abilities/natures_veil":
              "\u7ed9\u6240\u6709\u654c\u4eba\u8499\u4e0a\u4e00\u5c42\u83cc\u5e55\uff0c\u9020\u6210\u4f24\u5bb3\u5e76\u6709\u51e0\u7387\u4f7f\u5176\u5931\u660e",
            "/abilities/fireball":
              "\u5bf9\u76ee\u6807\u654c\u4eba\u65bd\u653e\u706b\u7403",
          ...
          itemNames: {
            ...
            "/items/icy_robe_top": "\u51b0\u971c\u957f\u888d",
            "/items/flaming_robe_top": "\u70c8\u7130\u957f\u888d",
            "/items/luna_robe_top": "\u6708\u795e\u957f\u888d",
            "/items/royal_water_robe_top":
              "\u7687\u5bb6\u6c34\u7cfb\u957f\u888d",
            "/items/royal_nature_robe_top":
              "\u7687\u5bb6\u81ea\u7136\u7cfb\u957f\u888d",
            ...
            "/items/cotton_robe_top": "\u68c9\u5e03\u4e0a\u8863",
            "/items/linen_robe_top": "\u4e9a\u9ebb\u4e0a\u8863",
            "/items/bamboo_robe_top": "\u7af9\u4e0a\u8863",
            "/items/silk_robe_top": "\u4e1d\u7ef8\u4e0a\u8863",
            "/items/radiant_robe_top": "\u5149\u8f89\u4e0a\u8863",
            ...
            "/items/icy_robe_bottoms": "\u51b0\u971c\u4e0b\u88c5",
            "/items/flaming_robe_bottoms": "\u70c8\u7130\u4e0b\u88c5",
            "/items/luna_robe_bottoms": "\u6708\u795e\u4e0b\u88c5",
            "/items/royal_water_robe_bottoms":
              "\u7687\u5bb6\u6c34\u7cfb\u4e0b\u88c5",
            "/items/royal_nature_robe_bottoms":
              "\u7687\u5bb6\u81ea\u7136\u7cfb\u4e0b\u88c5",
            ...
            "/items/cotton_robe_bottoms": "\u68c9\u4e0b\u88c5",
            "/items/linen_robe_bottoms": "\u4e9a\u9ebb\u4e0b\u88c5",
            "/items/bamboo_robe_bottoms": "\u7af9\u4e0b\u88c5",
            "/items/silk_robe_bottoms": "\u4e1d\u7ef8\u4e0b\u88c5",
            "/items/radiant_robe_bottoms": "\u5149\u8f89\u4e0b\u88c5",
          ...
          itemDescriptions: {
            ...
            "/items/task_token":
              "\u4efb\u52a1\u4ee3\u5e01\u3002\u53ef\u5728\u4efb\u52a1\u5546\u5e97\u4e2d\u4f7f\u7528\u8fd9\u4e9b\u4ee3\u5e01",
            "/items/chimerical_token":
              "\u6765\u81ea\u3010\u5947\u5e7b\u6d1e\u7a74\u3011\u7684\u5730\u4e0b\u57ce\u4ee3\u5e01\u3002\u53ef\u4ee5\u5728\u5730\u4e0b\u57ce\u5546\u5e97\u91cc\u6d88\u8d39",
            "/items/sinister_token":
              "\u6765\u81ea\u3010\u9634\u68ee\u9a6c\u620f\u56e2\u3011\u7684\u5730\u4e0b\u57ce\u4ee3\u5e01\u3002\u53ef\u4ee5\u5728\u5730\u4e0b\u57ce\u5546\u5e97\u91cc\u6d88\u8d39",
            "/items/enchanted_token":
              "\u6765\u81ea\u3010\u79d8\u6cd5\u8981\u585e\u3011\u7684\u5730\u4e0b\u57ce\u4ee3\u5e01\u3002\u53ef\u4ee5\u5728\u5730\u4e0b\u57ce\u5546\u5e97\u91cc\u6d88\u8d39",
            "/items/cowbell":
              "\u9ad8\u7ea7\u8d27\u5e01\u3002\u53ef\u5728\u725b\u94c3\u5546\u5e97\u8d2d\u4e70\u6216\u4f7f\u7528\u8fd9\u4e9b\u8d27\u5e01",
            "/items/bag_of_10_cowbells":
              "\u53ef\u4ea4\u6613\u7684\u4e00\u888b\u725b\u94c3\uff0c\u6bcf\u888b\u5305\u542b10\u4e2a\u725b\u94c3\u3002\u53ea\u80fd\u6574\u888b\u4ea4\u6613\uff0c\u4e00\u65e6\u6253\u5f00\u5c06\u65e0\u6cd5\u51fa\u552e",
            "/items/purples_gift":
              "\u83b7\u5f97\u4efb\u52a1\u79ef\u5206\u540e\u5c0f\u7d2b\u725b\u8d60\u9001\u7684\u793c\u7269\uff0c\u770b\u8d77\u6765\u91cc\u9762\u88c5\u7740\u7269\u54c1\uff01",
            "/items/small_meteorite_cache":
              "\u5728\u91c7\u96c6\u65f6\u53ef\u4ee5\u627e\u5230\uff0c\u770b\u8d77\u6765\u91cc\u9762\u88c5\u7740\u7269\u54c1\uff01",
            "/items/medium_meteorite_cache":
              "\u5728\u91c7\u96c6\u65f6\u53ef\u4ee5\u627e\u5230\uff0c\u770b\u8d77\u6765\u91cc\u9762\u88c5\u7740\u7269\u54c1\uff01",
            ...
            "/items/large_treasure_chest":
              "\u53ef\u4ee5\u4ece\u602a\u7269\u8eab\u4e0a\u627e\u5230\uff0c\u770b\u8d77\u6765\u91cc\u9762\u88c5\u7740\u7269\u54c1\uff01",
            "/items/chimerical_chest":
              "\u653b\u514b\u3010\u5947\u5e7b\u6d1e\u7a74\u3011\u540e\u7684\u5956\u52b1\uff0c\u53ef\u4ee5\u7528\u3010\u5947\u5e7b\u5b9d\u7bb1\u94a5\u5319\u3011\u6253\u5f00",
            "/items/sinister_chest":
              "\u653b\u514b\u3010\u9634\u68ee\u9a6c\u620f\u56e2\u3011\u540e\u7684\u5956\u52b1\uff0c\u53ef\u4ee5\u7528\u3010\u9634\u68ee\u5b9d\u7bb1\u94a5\u5319\u3011\u6253\u5f00",
            "/items/enchanted_chest":
              "\u653b\u514b\u3010\u79d8\u6cd5\u8981\u585e\u3011\u540e\u7684\u5956\u52b1\uff0c\u53ef\u4ee5\u7528\u3010\u79d8\u6cd5\u5b9d\u7bb1\u94a5\u5319\u3011\u6253\u5f00",
            "/items/blue_key_fragment":
              "\u770b\u8d77\u6765\u662f\u67d0\u79cd\u94a5\u5319\u7684\u788e\u7247\uff0c\u7528\u6765\u5236\u4f5c\u5730\u4e0b\u57ce\u94a5\u5319",
            "/items/green_key_fragment":
              "\u770b\u8d77\u6765\u662f\u67d0\u79cd\u94a5\u5319\u7684\u788e\u7247\uff0c\u7528\u6765\u5236\u4f5c\u5730\u4e0b\u57ce\u94a5\u5319",
            "/items/purple_key_fragment":
              "\u770b\u8d77\u6765\u662f\u67d0\u79cd\u94a5\u5319\u7684\u788e\u7247\uff0c\u7528\u6765\u5236\u4f5c\u5730\u4e0b\u57ce\u94a5\u5319",
            ...
            "/items/emp_tea_leaf": "",
            "/items/catalyst_of_coinification":
              "\u5728\u70bc\u91d1\u65f6\u4f7f\u7528\uff0c\u53ef\u63d0\u9ad815%\u7684\u70b9\u91d1\u6210\u529f\u7387 (\u4e58\u6cd5)\u3002\u6210\u529f\u65f6\u6d88\u8017\u4e00\u4e2a\u50ac\u5316\u5242\u3002",
            "/items/catalyst_of_decomposition":
              "\u5728\u70bc\u91d1\u65f6\u4f7f\u7528\uff0c\u53ef\u5c06\u5206\u89e3\u6210\u529f\u7387\u63d0\u9ad8 15% (\u4e58\u6cd5)\u3002\u6210\u529f\u65f6\u6d88\u8017\u4e00\u4e2a\u50ac\u5316\u5242\u3002",
            "/items/catalyst_of_transmutation":
              "\u5728\u70bc\u91d1\u65f6\u4f7f\u7528\uff0c\u53ef\u5c06\u8f6c\u5316\u6210\u529f\u7387\u63d0\u9ad8 15% (\u4e58\u6cd5)\u3002\u6210\u529f\u65f6\u6d88\u8017\u4e00\u4e2a\u50ac\u5316\u5242\u3002",
            "/items/prime_catalyst":
              "\u5728\u70bc\u91d1\u65f6\u4f7f\u7528\uff0c\u53ef\u5c06\u4efb\u4f55\u884c\u52a8\u7684\u6210\u529f\u7387\u63d0\u9ad8 25% (\u4e58\u6cd5)\u3002\u6210\u529f\u65f6\u6d88\u8017\u4e00\u4e2a\u50ac\u5316\u5242\u3002",
            "/items/snake_fang":
              "\u7528\u4e8e\u953b\u9020\u86c7\u7259\u77ed\u5251\u7684\u6750\u6599",
            "/items/shoebill_feather":
              "\u7528\u4e8e\u7f1d\u7eab\u9cb8\u5934\u9e73\u978b\u7684\u6750\u6599",
          ...
          actionNames: {
            ...
            "/actions/tailoring/reptile_tunic":
              "\u722c\u884c\u52a8\u7269\u76ae\u8863",
            "/actions/tailoring/linen_robe_top": "\u4e9a\u9ebb\u4e0a\u8863",
            ...
            "/actions/tailoring/gobo_tunic":
              "\u54e5\u5e03\u6797\u76ae\u8863",
            "/actions/tailoring/bamboo_robe_top": "\u7af9\u4e0a\u8863",
            "/actions/tailoring/marine_tunic": "\u6d77\u6d0b\u76ae\u8863",
            "/actions/tailoring/marine_chaps": "\u822a\u6d77\u76ae\u88e4",
            "/actions/tailoring/icy_robe_top": "\u51b0\u971c\u4e0a\u8863",
            ...
            "/actions/tailoring/silk_robe_top": "\u4e1d\u7ef8\u4e0a\u8863",
            "/actions/tailoring/red_culinary_hat":
              "\u7ea2\u8272\u53a8\u5e08\u5e3d",
            "/actions/tailoring/luna_robe_top": "\u6708\u795e\u4e0a\u8863",
          ...
          buffTypeNames: {
            ...
            "/buff_types/physical_thorns": "\u7269\u7406\u53cd\u4f24",
            "/buff_types/elemental_thorns": "\u5143\u7d20\u53cd\u4f24",
          ...
          cowbellBundleNames: {
            "/cowbell_bundles/cowbells_500": "500\u4e2a\u725b\u94c3",
            "/cowbell_bundles/cowbells_1050": "1050\u4e2a\u725b\u94c3",
            "/cowbell_bundles/cowbells_2700": "2700\u4e2a\u725b\u94c3",
            "/cowbell_bundles/cowbells_5500": "5500\u4e2a\u725b\u94c3",
            "/cowbell_bundles/cowbells_11500": "11500\u4e2a\u725b\u94c3",
          },
          buyableUpgradeNames: {
            "/buyable_upgrades/offline_hour_cap_1":
              "+1\u5c0f\u65f6\u79bb\u7ebf\u8fdb\u5ea6",
            ...
            "/buyable_upgrades/offline_hour_cap_4":
              "+1\u5c0f\u65f6\u79bb\u7ebf\u8fdb\u5ea6",
            "/buyable_upgrades/market_listing_cap_1":
              "+1\u5e02\u573a\u6302\u724c",
            "/buyable_upgrades/market_listing_cap_2":
              "+1\u5e02\u573a\u6302\u724c",
            "/buyable_upgrades/market_listing_cap_3":
              "+1\u5e02\u573a\u6302\u724c",
            "/buyable_upgrades/market_listing_cap_4":
              "+1\u5e02\u573a\u6302\u724c",
            "/buyable_upgrades/market_listing_cap_5":
              "+1\u5e02\u573a\u6302\u724c",
            "/buyable_upgrades/action_queue_cap_1":
              "+1\u884c\u52a8\u961f\u5217",
            "/buyable_upgrades/action_queue_cap_2":
              "+1\u884c\u52a8\u961f\u5217",
            "/buyable_upgrades/action_queue_cap_3":
              "+1\u884c\u52a8\u961f\u5217",
            "/buyable_upgrades/action_queue_cap_4":
              "+1\u884c\u52a8\u961f\u5217",
            "/buyable_upgrades/loadout_slot_cap_1":
              "+1\u914d\u88c5\u69fd\u4f4d",
            "/buyable_upgrades/loadout_slot_cap_2":
              "+1\u914d\u88c5\u69fd\u4f4d",
            "/buyable_upgrades/loadout_slot_cap_3":
              "+1\u914d\u88c5\u69fd\u4f4d",
            "/buyable_upgrades/loadout_slot_cap_4":
              "+1\u914d\u88c5\u69fd\u4f4d",
            "/buyable_upgrades/task_slot_cap_1":
              "+1\u4efb\u52a1\u69fd\u4f4d",
            "/buyable_upgrades/task_slot_cap_2":
              "+1\u4efb\u52a1\u69fd\u4f4d",
            "/buyable_upgrades/task_slot_cap_3":
              "+1\u4efb\u52a1\u69fd\u4f4d",
            "/buyable_upgrades/task_slot_cap_4":
              "+1\u4efb\u52a1\u69fd\u4f4d",
          },
          chatIconNames: {
            "/chat_icons/admin": "Admin",
            ...
            "/chat_icons/mooberry": "\u54de\u6885",
            "/chat_icons/marsberry": "\u706b\u661f\u6885",
            "/chat_icons/spaceberry": "\u592a\u7a7a\u6885",
            "/chat_icons/apple": "\u82f9\u679c",
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    i18next
       .use(i18nextHttpBackend)
        ...
        i18next.addResourceBundle('en', 'translation', Oa.en.translation);
        i18next.addResourceBundle('zh', 'translation', Oa.zh.translation);
